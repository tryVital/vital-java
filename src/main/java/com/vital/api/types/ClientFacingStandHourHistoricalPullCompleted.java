...
@JsonDeserialize(builder = ClientFacingStandHourHistoricalPullCompleted.Builder.class)
public final class ClientFacingStandHourHistoricalPullCompleted {
    ...
    private ClientFacingStandHourHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.stand_hour.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingStandHourHistoricalPullCompleted
                && equalTo((ClientFacingStandHourHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingStandHourHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingStandHourHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingStandHourHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingStandHourHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingStandHourHistoricalPullCompleted build() {
            return new ClientFacingStandHourHistoricalPullCompleted(
