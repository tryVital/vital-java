...
@JsonDeserialize(builder = ClientFacingCaloriesActiveChanged.Builder.class)
public final class ClientFacingCaloriesActiveChanged {
    private final ClientFacingCaloriesActiveChangedEventType eventType;
    ...
    private ClientFacingCaloriesActiveChanged(
            ClientFacingCaloriesActiveChangedEventType eventType,
            String userId,
            String clientUserId,
            String teamId,
    ...
    public ClientFacingCaloriesActiveChangedEventType getEventType() {
        return eventType;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingCaloriesActiveChanged && equalTo((ClientFacingCaloriesActiveChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingCaloriesActiveChanged other) {
    ...
    public interface EventTypeStage {
        UserIdStage eventType(ClientFacingCaloriesActiveChangedEventType eventType);

        Builder from(ClientFacingCaloriesActiveChanged other);
    }
    ...
    public interface DataStage {
        _FinalStage data(GroupedCaloriesActive data);
    }
    ...
    public static final class Builder
        ...
        private ClientFacingCaloriesActiveChangedEventType eventType;
        ...
        @java.lang.Override
        public Builder from(ClientFacingCaloriesActiveChanged other) {
        ...
        public UserIdStage eventType(ClientFacingCaloriesActiveChangedEventType eventType) {
            this.eventType = eventType;
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(GroupedCaloriesActive data) {
            this.data = data;
            return this;
        }
