...
@JsonDeserialize(builder = ClientFacingIgeTimeseries.Builder.class)
public final class ClientFacingIgeTimeseries {
    ...
    private ClientFacingIgeTimeseries(
            Optional<Integer> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingIgeTimeseries && equalTo((ClientFacingIgeTimeseries) other);
    }

    private boolean equalTo(ClientFacingIgeTimeseries other) {
    ...
    public interface TimestampStage {
        ...
        Builder from(ClientFacingIgeTimeseries other);
    }
    ...
    public interface _FinalStage {
        ClientFacingIgeTimeseries build();
    ...
    public static final class Builder implements TimestampStage, ValueStage, UnitStage, _FinalStage {
        ...
        @Override
        public Builder from(ClientFacingIgeTimeseries other) {
            id(other.getId());
        ...
        @Override
        public ClientFacingIgeTimeseries build() {
            return new ClientFacingIgeTimeseries(id, timestamp, timezoneOffset, value, type, unit);
        }
    }
}
