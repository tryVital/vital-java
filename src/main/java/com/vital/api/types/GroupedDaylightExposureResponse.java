...
public final class GroupedDaylightExposureResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedDaylightExposureResponse && equalTo((GroupedDaylightExposureResponse) other);
    }
    ...
    private boolean equalTo(GroupedDaylightExposureResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedDaylightExposureResponse other) {
        ...
        public GroupedDaylightExposureResponse build() {
            return new GroupedDaylightExposureResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
