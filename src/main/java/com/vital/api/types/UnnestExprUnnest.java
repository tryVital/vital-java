...
@JsonDeserialize(using = UnnestExprUnnest.Deserializer.class)
public final class UnnestExprUnnest {
    private final Object value;

    private final int type;

    private UnnestExprUnnest(Object value, int type) {
        this.value = value;
        this.type = type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UnnestExprUnnest && equalTo((UnnestExprUnnest) other);
    }

    private boolean equalTo(UnnestExprUnnest other) {
    ...
    public static UnnestExprUnnest of(SleepColumnExpr value) {
        return new UnnestExprUnnest(value, 0);
    }

    public static UnnestExprUnnest of(DerivedReadinessColumnExpr value) {
    ...
    static final class Deserializer extends StdDeserializer<UnnestExprUnnest> {
        Deserializer() {
            super(UnnestExprUnnest.class);
        }

        @java.lang.Override
        public UnnestExprUnnest deserialize(JsonParser p, DeserializationContext context) throws IOException {
