...
@JsonDeserialize(builder = ClientFacingStepsTimeseries.Builder.class)
public final class ClientFacingStepsTimeseries {
    ...
    private ClientFacingStepsTimeseries(
            Optional<Integer> id,
    ...
    /**
     * @return The number of steps sampled at the time or interval::count
     */
    @JsonProperty("value")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingStepsTimeseries && equalTo((ClientFacingStepsTimeseries) other);
    }
    ...
    private boolean equalTo(ClientFacingStepsTimeseries other) {
    ...
    public interface TimestampStage {
        ...
        Builder from(ClientFacingStepsTimeseries other);
    }
    ...
    public interface _FinalStage {
        ClientFacingStepsTimeseries build();
    ...
    public static final class Builder implements TimestampStage, StartStage, EndStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingStepsTimeseries other) {
            id(other.getId());
        ...
        /**
         * <p>The number of steps sampled at the time or interval::count</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        @JsonSetter("value")
        ...
        @java.lang.Override
        public ClientFacingStepsTimeseries build() {
            return new ClientFacingStepsTimeseries(
