...
@JsonDeserialize(builder = ClientFacingInhalerUsageHistoricalPullCompleted.Builder.class)
public final class ClientFacingInhalerUsageHistoricalPullCompleted {
    ...
    private ClientFacingInhalerUsageHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.inhaler_usage.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingInhalerUsageHistoricalPullCompleted
                && equalTo((ClientFacingInhalerUsageHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingInhalerUsageHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingInhalerUsageHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingInhalerUsageHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingInhalerUsageHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingInhalerUsageHistoricalPullCompleted build() {
            return new ClientFacingInhalerUsageHistoricalPullCompleted(
