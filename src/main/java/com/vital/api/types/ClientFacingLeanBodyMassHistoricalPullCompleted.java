...
@JsonDeserialize(builder = ClientFacingLeanBodyMassHistoricalPullCompleted.Builder.class)
public final class ClientFacingLeanBodyMassHistoricalPullCompleted {
    ...
    private ClientFacingLeanBodyMassHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.lean_body_mass.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingLeanBodyMassHistoricalPullCompleted
                && equalTo((ClientFacingLeanBodyMassHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingLeanBodyMassHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingLeanBodyMassHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingLeanBodyMassHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingLeanBodyMassHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingLeanBodyMassHistoricalPullCompleted build() {
            return new ClientFacingLeanBodyMassHistoricalPullCompleted(
