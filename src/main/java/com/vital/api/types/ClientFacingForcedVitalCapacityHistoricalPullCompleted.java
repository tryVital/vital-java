...
@JsonDeserialize(builder = ClientFacingForcedVitalCapacityHistoricalPullCompleted.Builder.class)
public final class ClientFacingForcedVitalCapacityHistoricalPullCompleted {
    ...
    private ClientFacingForcedVitalCapacityHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.forced_vital_capacity.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingForcedVitalCapacityHistoricalPullCompleted
                && equalTo((ClientFacingForcedVitalCapacityHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingForcedVitalCapacityHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingForcedVitalCapacityHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingForcedVitalCapacityHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingForcedVitalCapacityHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingForcedVitalCapacityHistoricalPullCompleted build() {
            return new ClientFacingForcedVitalCapacityHistoricalPullCompleted(
