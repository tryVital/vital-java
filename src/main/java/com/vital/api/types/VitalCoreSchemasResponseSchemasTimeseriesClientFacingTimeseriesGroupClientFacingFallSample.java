...
@JsonDeserialize(
        builder =
                VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample.Builder
                        .class)
public final class VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample {
    ...
    private VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample(
    ...
    public boolean equals(Object other) {
        ...
        return other
                ...
                && equalTo((VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample)
                        other);
    }
    ...
    private boolean equalTo(
            VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample other) {
    ...
    public interface SourceStage {
        ...
        Builder from(VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample other);
    }

    public interface _FinalStage {
        VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample build();
    ...
    public static final class Builder implements SourceStage, _FinalStage {
        ...
        @java.lang.Override
        public VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample build() {
            return new VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample(
