...
@JsonDeserialize(builder = ClientFacingBodyMassIndexHistoricalPullCompleted.Builder.class)
public final class ClientFacingBodyMassIndexHistoricalPullCompleted {
    ...
    private ClientFacingBodyMassIndexHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.body_mass_index.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBodyMassIndexHistoricalPullCompleted
                && equalTo((ClientFacingBodyMassIndexHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBodyMassIndexHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBodyMassIndexHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBodyMassIndexHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBodyMassIndexHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBodyMassIndexHistoricalPullCompleted build() {
            return new ClientFacingBodyMassIndexHistoricalPullCompleted(
