...
@JsonDeserialize(builder = ClientFacingGlucoseHistoricalPullCompleted.Builder.class)
public final class ClientFacingGlucoseHistoricalPullCompleted {
    ...
    private ClientFacingGlucoseHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.glucose.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingGlucoseHistoricalPullCompleted
                && equalTo((ClientFacingGlucoseHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingGlucoseHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingGlucoseHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingGlucoseHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingGlucoseHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingGlucoseHistoricalPullCompleted build() {
            return new ClientFacingGlucoseHistoricalPullCompleted(
