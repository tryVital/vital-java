...
public final class HealthInsuranceCreateRequestBackImage {
    ...
    private HealthInsuranceCreateRequestBackImage(Value value) {
        this.value = value;
    }
    ...
    public static HealthInsuranceCreateRequestBackImage imageJpeg(Jpeg value) {
        return new HealthInsuranceCreateRequestBackImage(new ImageJpegValue(value));
    }

    public static HealthInsuranceCreateRequestBackImage imagePng(Png value) {
        return new HealthInsuranceCreateRequestBackImage(new ImagePngValue(value));
    }
    ...
    private static final class ImageJpegValue implements Value {
        ...
        public String toString() {
            return "HealthInsuranceCreateRequestBackImage{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @Override
        public String toString() {
            return "HealthInsuranceCreateRequestBackImage{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
