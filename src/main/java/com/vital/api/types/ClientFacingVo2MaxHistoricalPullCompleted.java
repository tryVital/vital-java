...
@JsonDeserialize(builder = ClientFacingVo2MaxHistoricalPullCompleted.Builder.class)
public final class ClientFacingVo2MaxHistoricalPullCompleted {
    ...
    private ClientFacingVo2MaxHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.vo2_max.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingVo2MaxHistoricalPullCompleted
                && equalTo((ClientFacingVo2MaxHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingVo2MaxHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingVo2MaxHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingVo2MaxHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingVo2MaxHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingVo2MaxHistoricalPullCompleted build() {
            return new ClientFacingVo2MaxHistoricalPullCompleted(
