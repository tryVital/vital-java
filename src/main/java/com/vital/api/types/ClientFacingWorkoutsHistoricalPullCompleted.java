...
@JsonDeserialize(builder = ClientFacingWorkoutsHistoricalPullCompleted.Builder.class)
public final class ClientFacingWorkoutsHistoricalPullCompleted {
    ...
    private ClientFacingWorkoutsHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.workouts.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWorkoutsHistoricalPullCompleted
                && equalTo((ClientFacingWorkoutsHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWorkoutsHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWorkoutsHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWorkoutsHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWorkoutsHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWorkoutsHistoricalPullCompleted build() {
            return new ClientFacingWorkoutsHistoricalPullCompleted(
