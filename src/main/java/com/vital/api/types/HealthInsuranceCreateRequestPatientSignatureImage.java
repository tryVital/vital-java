...
public final class HealthInsuranceCreateRequestPatientSignatureImage {
    ...
    private HealthInsuranceCreateRequestPatientSignatureImage(Value value) {
        this.value = value;
    }
    ...
    public static HealthInsuranceCreateRequestPatientSignatureImage imageJpeg(Jpeg value) {
        return new HealthInsuranceCreateRequestPatientSignatureImage(new ImageJpegValue(value));
    }

    public static HealthInsuranceCreateRequestPatientSignatureImage imagePng(Png value) {
        return new HealthInsuranceCreateRequestPatientSignatureImage(new ImagePngValue(value));
    }
    ...
    private static final class ImageJpegValue implements Value {
        ...
        public String toString() {
            return "HealthInsuranceCreateRequestPatientSignatureImage{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @Override
        public String toString() {
            return "HealthInsuranceCreateRequestPatientSignatureImage{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
