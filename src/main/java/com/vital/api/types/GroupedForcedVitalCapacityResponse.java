...
public final class GroupedForcedVitalCapacityResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedForcedVitalCapacityResponse
                && equalTo((GroupedForcedVitalCapacityResponse) other);
    }
    ...
    private boolean equalTo(GroupedForcedVitalCapacityResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedForcedVitalCapacityResponse other) {
        ...
        public GroupedForcedVitalCapacityResponse build() {
            return new GroupedForcedVitalCapacityResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
