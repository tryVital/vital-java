...
public final class Subject {
    ...
    private Subject(String reference, Optional<String> display, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Subject && equalTo((Subject) other);
    }
    ...
    private boolean equalTo(Subject other) {
    ...
    public static final class Builder implements ReferenceStage, _FinalStage {
        ...
        @Override
        public Builder from(Subject other) {
        ...
        public Subject build() {
            return new Subject(reference, display, additionalProperties);
        }
    }
}
