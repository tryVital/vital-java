...
@JsonDeserialize(builder = ClientFacingSleepApneaAlertHistoricalPullCompleted.Builder.class)
public final class ClientFacingSleepApneaAlertHistoricalPullCompleted {
    ...
    private ClientFacingSleepApneaAlertHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.sleep_apnea_alert.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingSleepApneaAlertHistoricalPullCompleted
                && equalTo((ClientFacingSleepApneaAlertHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingSleepApneaAlertHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingSleepApneaAlertHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingSleepApneaAlertHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingSleepApneaAlertHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingSleepApneaAlertHistoricalPullCompleted build() {
            return new ClientFacingSleepApneaAlertHistoricalPullCompleted(
