...
@JsonDeserialize(builder = ClientFacingCarbohydratesHistoricalPullCompleted.Builder.class)
public final class ClientFacingCarbohydratesHistoricalPullCompleted {
    ...
    private ClientFacingCarbohydratesHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.carbohydrates.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingCarbohydratesHistoricalPullCompleted
                && equalTo((ClientFacingCarbohydratesHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingCarbohydratesHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingCarbohydratesHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingCarbohydratesHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingCarbohydratesHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingCarbohydratesHistoricalPullCompleted build() {
            return new ClientFacingCarbohydratesHistoricalPullCompleted(
