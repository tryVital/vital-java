...
@JsonDeserialize(builder = ClientFacingCaloriesActiveHistoricalPullCompleted.Builder.class)
public final class ClientFacingCaloriesActiveHistoricalPullCompleted {
    ...
    private ClientFacingCaloriesActiveHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.calories_active.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingCaloriesActiveHistoricalPullCompleted
                && equalTo((ClientFacingCaloriesActiveHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingCaloriesActiveHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingCaloriesActiveHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingCaloriesActiveHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingCaloriesActiveHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingCaloriesActiveHistoricalPullCompleted build() {
            return new ClientFacingCaloriesActiveHistoricalPullCompleted(
