...
public final class GroupedInhalerUsageResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedInhalerUsageResponse && equalTo((GroupedInhalerUsageResponse) other);
    }
    ...
    private boolean equalTo(GroupedInhalerUsageResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedInhalerUsageResponse other) {
        ...
        public GroupedInhalerUsageResponse build() {
            return new GroupedInhalerUsageResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
