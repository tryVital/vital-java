...
@JsonDeserialize(builder = ClientFacingWaterTimeseries.Builder.class)
public final class ClientFacingWaterTimeseries {
    ...
    private ClientFacingWaterTimeseries(
            Optional<Integer> id,
    ...
    /**
     * @return Quantity of water drank during the time period.
     */
    @JsonProperty("value")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWaterTimeseries && equalTo((ClientFacingWaterTimeseries) other);
    }

    private boolean equalTo(ClientFacingWaterTimeseries other) {
    ...
    public interface TimestampStage {
        ...
        Builder from(ClientFacingWaterTimeseries other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWaterTimeseries build();
    ...
    public static final class Builder implements TimestampStage, ValueStage, UnitStage, _FinalStage {
        ...
        @Override
        public Builder from(ClientFacingWaterTimeseries other) {
            id(other.getId());
        ...
        @Override
        public ClientFacingWaterTimeseries build() {
            return new ClientFacingWaterTimeseries(id, timestamp, timezoneOffset, value, type, unit);
        }
    }
}
