...
@JsonDeserialize(builder = ClientFacingBodyHistoricalPullCompleted.Builder.class)
public final class ClientFacingBodyHistoricalPullCompleted {
    ...
    private ClientFacingBodyHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.body.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBodyHistoricalPullCompleted
                && equalTo((ClientFacingBodyHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBodyHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBodyHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBodyHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBodyHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBodyHistoricalPullCompleted build() {
            return new ClientFacingBodyHistoricalPullCompleted(
