...
@JsonDeserialize(builder = ClientFacingCaloriesBasalHistoricalPullCompleted.Builder.class)
public final class ClientFacingCaloriesBasalHistoricalPullCompleted {
    ...
    private ClientFacingCaloriesBasalHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.calories_basal.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingCaloriesBasalHistoricalPullCompleted
                && equalTo((ClientFacingCaloriesBasalHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingCaloriesBasalHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingCaloriesBasalHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingCaloriesBasalHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingCaloriesBasalHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingCaloriesBasalHistoricalPullCompleted build() {
            return new ClientFacingCaloriesBasalHistoricalPullCompleted(
