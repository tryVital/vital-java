...
@JsonDeserialize(builder = ClientFacingCholesterolHistoricalPullCompleted.Builder.class)
public final class ClientFacingCholesterolHistoricalPullCompleted {
    ...
    private ClientFacingCholesterolHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.cholesterol.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingCholesterolHistoricalPullCompleted
                && equalTo((ClientFacingCholesterolHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingCholesterolHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingCholesterolHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingCholesterolHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingCholesterolHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingCholesterolHistoricalPullCompleted build() {
            return new ClientFacingCholesterolHistoricalPullCompleted(
