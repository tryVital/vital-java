...
@JsonDeserialize(builder = ClientFacingActivityHistoricalPullCompleted.Builder.class)
public final class ClientFacingActivityHistoricalPullCompleted {
    ...
    private ClientFacingActivityHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.activity.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingActivityHistoricalPullCompleted
                && equalTo((ClientFacingActivityHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingActivityHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingActivityHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingActivityHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingActivityHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingActivityHistoricalPullCompleted build() {
            return new ClientFacingActivityHistoricalPullCompleted(
