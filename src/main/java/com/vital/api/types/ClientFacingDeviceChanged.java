...
public final class ClientFacingDeviceChanged {
    ...
    private final ClientFacingDevice data;

    private final Map<String, Object> additionalProperties;

    private ClientFacingDeviceChanged(
            ClientFacingDeviceChangedEventType eventType,
            String userId,
            String clientUserId,
            String teamId,
            ClientFacingDevice data,
    ...
    public ClientFacingDeviceChangedEventType getEventType() {
        return eventType;
    }
    ...
    @JsonProperty("data")
    public ClientFacingDevice getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingDeviceChanged && equalTo((ClientFacingDeviceChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingDeviceChanged other) {
    ...
    public static final class Builder
        ...
        private ClientFacingDevice data;
        ...
        @java.lang.Override
        public Builder from(ClientFacingDeviceChanged other) {
        ...
        @java.lang.Override
        public ClientFacingDeviceChanged build() {
            return new ClientFacingDeviceChanged(eventType, userId, clientUserId, teamId, data, additionalProperties);
        }
    }
}
