...
@JsonDeserialize(builder = ClientFacingWaterHistoricalPullCompleted.Builder.class)
public final class ClientFacingWaterHistoricalPullCompleted {
    ...
    private ClientFacingWaterHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.water.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWaterHistoricalPullCompleted
                && equalTo((ClientFacingWaterHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWaterHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWaterHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWaterHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWaterHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWaterHistoricalPullCompleted build() {
            return new ClientFacingWaterHistoricalPullCompleted(
