...
public final class ClientFacingAfibBurdenHistoricalPullCompleted {
    ...
    private ClientFacingAfibBurdenHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.afib_burden.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingAfibBurdenHistoricalPullCompleted
                && equalTo((ClientFacingAfibBurdenHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingAfibBurdenHistoricalPullCompleted other) {
    ...
    public interface _FinalStage {
        ClientFacingAfibBurdenHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingAfibBurdenHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingAfibBurdenHistoricalPullCompleted build() {
            return new ClientFacingAfibBurdenHistoricalPullCompleted(
