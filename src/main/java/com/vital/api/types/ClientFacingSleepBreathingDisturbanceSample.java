...
public final class ClientFacingSleepBreathingDisturbanceSample {
    ...
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("type")
    private Optional<ClientFacingSleepBreathingDisturbanceSampleType> _getType() {
        return type;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage type(Nullable<ClientFacingSleepBreathingDisturbanceSampleType> type);
    }
    ...
    public static final class Builder implements TimestampStage, StartStage, EndStage, ValueStage, _FinalStage {
         ...
         */
        @java.lang.Override
        public _FinalStage type(Nullable<ClientFacingSleepBreathingDisturbanceSampleType> type) {
            if (type.isNull()) {
                this.type = null;
