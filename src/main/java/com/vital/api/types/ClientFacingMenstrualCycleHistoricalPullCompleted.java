...
@JsonDeserialize(builder = ClientFacingMenstrualCycleHistoricalPullCompleted.Builder.class)
public final class ClientFacingMenstrualCycleHistoricalPullCompleted {
    ...
    private ClientFacingMenstrualCycleHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.menstrual_cycle.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingMenstrualCycleHistoricalPullCompleted
                && equalTo((ClientFacingMenstrualCycleHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingMenstrualCycleHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingMenstrualCycleHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingMenstrualCycleHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingMenstrualCycleHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingMenstrualCycleHistoricalPullCompleted build() {
            return new ClientFacingMenstrualCycleHistoricalPullCompleted(
