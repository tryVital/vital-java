...
@JsonDeserialize(builder = ClientFacingIggHistoricalPullCompleted.Builder.class)
public final class ClientFacingIggHistoricalPullCompleted {
    ...
    private ClientFacingIggHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.igg.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingIggHistoricalPullCompleted
                && equalTo((ClientFacingIggHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingIggHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingIggHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingIggHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingIggHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingIggHistoricalPullCompleted build() {
            return new ClientFacingIggHistoricalPullCompleted(userId, clientUserId, teamId, data, additionalProperties);
        }
    }
}
