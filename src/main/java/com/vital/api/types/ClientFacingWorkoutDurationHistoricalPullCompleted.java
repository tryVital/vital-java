...
@JsonDeserialize(builder = ClientFacingWorkoutDurationHistoricalPullCompleted.Builder.class)
public final class ClientFacingWorkoutDurationHistoricalPullCompleted {
    ...
    private ClientFacingWorkoutDurationHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.workout_duration.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWorkoutDurationHistoricalPullCompleted
                && equalTo((ClientFacingWorkoutDurationHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWorkoutDurationHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWorkoutDurationHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWorkoutDurationHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWorkoutDurationHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWorkoutDurationHistoricalPullCompleted build() {
            return new ClientFacingWorkoutDurationHistoricalPullCompleted(
