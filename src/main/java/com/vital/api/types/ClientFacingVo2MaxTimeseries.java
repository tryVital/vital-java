...
@JsonDeserialize(builder = ClientFacingVo2MaxTimeseries.Builder.class)
public final class ClientFacingVo2MaxTimeseries {
    ...
    private ClientFacingVo2MaxTimeseries(
            Optional<Integer> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingVo2MaxTimeseries && equalTo((ClientFacingVo2MaxTimeseries) other);
    }
    ...
    private boolean equalTo(ClientFacingVo2MaxTimeseries other) {
    ...
    public interface UnitStage {
        ...
        Builder from(ClientFacingVo2MaxTimeseries other);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Builder from(ClientFacingVo2MaxTimeseries other) {
            id(other.getId());
