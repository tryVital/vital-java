...
@JsonDeserialize(builder = ClientFacingHeartRateAlertHistoricalPullCompleted.Builder.class)
public final class ClientFacingHeartRateAlertHistoricalPullCompleted {
    ...
    private ClientFacingHeartRateAlertHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.heart_rate_alert.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingHeartRateAlertHistoricalPullCompleted
                && equalTo((ClientFacingHeartRateAlertHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingHeartRateAlertHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingHeartRateAlertHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingHeartRateAlertHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingHeartRateAlertHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingHeartRateAlertHistoricalPullCompleted build() {
            return new ClientFacingHeartRateAlertHistoricalPullCompleted(
