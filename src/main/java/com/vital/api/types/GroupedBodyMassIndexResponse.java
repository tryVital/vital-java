...
@JsonDeserialize(builder = GroupedBodyMassIndexResponse.Builder.class)
public final class GroupedBodyMassIndexResponse {
    private final Map<String, List<GroupedBodyMassIndex>> groups;
    ...
    private GroupedBodyMassIndexResponse(
            Map<String, List<GroupedBodyMassIndex>> groups,
     ...
     */
    @JsonProperty("groups")
    public Map<String, List<GroupedBodyMassIndex>> getGroups() {
        return groups;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedBodyMassIndexResponse && equalTo((GroupedBodyMassIndexResponse) other);
    }
    ...
    private boolean equalTo(GroupedBodyMassIndexResponse other) {
    ...
    public static final class Builder {
        private Map<String, List<GroupedBodyMassIndex>> groups = new LinkedHashMap<>();
        ...
        public Builder from(GroupedBodyMassIndexResponse other) {
        ...
        public Builder groups(Map<String, List<GroupedBodyMassIndex>> groups) {
            this.groups.clear();
            this.groups.putAll(groups);
            return this;
        }

        public Builder putAllGroups(Map<String, List<GroupedBodyMassIndex>> groups) {
            if (groups != null) {
                this.groups.putAll(groups);
            }
            return this;
        ...
        public Builder groups(String key, List<GroupedBodyMassIndex> value) {
        ...
        public GroupedBodyMassIndexResponse build() {
            return new GroupedBodyMassIndexResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
