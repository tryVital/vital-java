...
@JsonDeserialize(builder = ClientFacingWorkoutStreamHistoricalPullCompleted.Builder.class)
public final class ClientFacingWorkoutStreamHistoricalPullCompleted {
    ...
    private ClientFacingWorkoutStreamHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.workout_stream.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWorkoutStreamHistoricalPullCompleted
                && equalTo((ClientFacingWorkoutStreamHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWorkoutStreamHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWorkoutStreamHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWorkoutStreamHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWorkoutStreamHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWorkoutStreamHistoricalPullCompleted build() {
            return new ClientFacingWorkoutStreamHistoricalPullCompleted(
