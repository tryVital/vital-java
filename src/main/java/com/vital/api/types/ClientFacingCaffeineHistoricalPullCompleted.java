...
@JsonDeserialize(builder = ClientFacingCaffeineHistoricalPullCompleted.Builder.class)
public final class ClientFacingCaffeineHistoricalPullCompleted {
    ...
    private ClientFacingCaffeineHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.caffeine.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingCaffeineHistoricalPullCompleted
                && equalTo((ClientFacingCaffeineHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingCaffeineHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingCaffeineHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingCaffeineHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingCaffeineHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingCaffeineHistoricalPullCompleted build() {
            return new ClientFacingCaffeineHistoricalPullCompleted(
