...
@JsonDeserialize(builder = ClientFacingRespiratoryRateHistoricalPullCompleted.Builder.class)
public final class ClientFacingRespiratoryRateHistoricalPullCompleted {
    ...
    private ClientFacingRespiratoryRateHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.respiratory_rate.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingRespiratoryRateHistoricalPullCompleted
                && equalTo((ClientFacingRespiratoryRateHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingRespiratoryRateHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingRespiratoryRateHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingRespiratoryRateHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingRespiratoryRateHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingRespiratoryRateHistoricalPullCompleted build() {
            return new ClientFacingRespiratoryRateHistoricalPullCompleted(
