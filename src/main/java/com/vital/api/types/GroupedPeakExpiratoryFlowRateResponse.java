...
public final class GroupedPeakExpiratoryFlowRateResponse {
    ...
    private GroupedPeakExpiratoryFlowRateResponse(
            Map<String, List<GroupedPeakExpiratoryFlowRate>> groups,
     ...
     */
    @JsonProperty("groups")
    public Map<String, List<GroupedPeakExpiratoryFlowRate>> getGroups() {
        return groups;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedPeakExpiratoryFlowRateResponse
                && equalTo((GroupedPeakExpiratoryFlowRateResponse) other);
    }
    ...
    private boolean equalTo(GroupedPeakExpiratoryFlowRateResponse other) {
    ...
    public static final class Builder {
        private Map<String, List<GroupedPeakExpiratoryFlowRate>> groups = new LinkedHashMap<>();
        ...
        public Builder from(GroupedPeakExpiratoryFlowRateResponse other) {
        ...
        public Builder groups(String key, List<GroupedPeakExpiratoryFlowRate> value) {
        ...
        public GroupedPeakExpiratoryFlowRateResponse build() {
            return new GroupedPeakExpiratoryFlowRateResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
