...
public final class GroupedHandwashingResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedHandwashingResponse && equalTo((GroupedHandwashingResponse) other);
    }
    ...
    private boolean equalTo(GroupedHandwashingResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedHandwashingResponse other) {
        ...
        public GroupedHandwashingResponse build() {
            return new GroupedHandwashingResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
