...
@JsonDeserialize(builder = ClientFacingUvExposureHistoricalPullCompleted.Builder.class)
public final class ClientFacingUvExposureHistoricalPullCompleted {
    ...
    private ClientFacingUvExposureHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.uv_exposure.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingUvExposureHistoricalPullCompleted
                && equalTo((ClientFacingUvExposureHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingUvExposureHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingUvExposureHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingUvExposureHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingUvExposureHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingUvExposureHistoricalPullCompleted build() {
            return new ClientFacingUvExposureHistoricalPullCompleted(
