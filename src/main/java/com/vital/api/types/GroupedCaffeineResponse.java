...
public final class GroupedCaffeineResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedCaffeineResponse && equalTo((GroupedCaffeineResponse) other);
    }
    ...
    private boolean equalTo(GroupedCaffeineResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedCaffeineResponse other) {
        ...
        public GroupedCaffeineResponse build() {
            return new GroupedCaffeineResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
