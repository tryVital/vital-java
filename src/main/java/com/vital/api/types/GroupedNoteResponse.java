...
public final class GroupedNoteResponse {
    private final Map<
                    String,
                    List<VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingNoteSample>>
            groups;
     ...
     */
    @JsonProperty("groups")
    public Map<String, List<VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingNoteSample>>
            getGroups() {
        return groups;
    }
