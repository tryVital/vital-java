...
@JsonDeserialize(builder = GroupedNoteResponse.Builder.class)
public final class GroupedNoteResponse {
    private final Map<String, List<GroupedNote>> groups;
    ...
    private GroupedNoteResponse(
            Map<String, List<GroupedNote>> groups,
     ...
     */
    @JsonProperty("groups")
    public Map<String, List<GroupedNote>> getGroups() {
        return groups;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedNoteResponse && equalTo((GroupedNoteResponse) other);
    }
    ...
    private boolean equalTo(GroupedNoteResponse other) {
    ...
    public static final class Builder {
        private Map<String, List<GroupedNote>> groups = new LinkedHashMap<>();
        ...
        public Builder from(GroupedNoteResponse other) {
        ...
        public Builder groups(Map<String, List<GroupedNote>> groups) {
            this.groups.clear();
            this.groups.putAll(groups);
            return this;
        }

        public Builder putAllGroups(Map<String, List<GroupedNote>> groups) {
            if (groups != null) {
                this.groups.putAll(groups);
            }
            return this;
        ...
        public Builder groups(String key, List<GroupedNote> value) {
        ...
        public GroupedNoteResponse build() {
            return new GroupedNoteResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
