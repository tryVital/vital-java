...
@JsonDeserialize(builder = ClientFacingHandwashingHistoricalPullCompleted.Builder.class)
public final class ClientFacingHandwashingHistoricalPullCompleted {
    ...
    private ClientFacingHandwashingHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.handwashing.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingHandwashingHistoricalPullCompleted
                && equalTo((ClientFacingHandwashingHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingHandwashingHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingHandwashingHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingHandwashingHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingHandwashingHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingHandwashingHistoricalPullCompleted build() {
            return new ClientFacingHandwashingHistoricalPullCompleted(
