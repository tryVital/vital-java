...
@JsonDeserialize(builder = ClientFacingFloorsClimbedHistoricalPullCompleted.Builder.class)
public final class ClientFacingFloorsClimbedHistoricalPullCompleted {
    ...
    private ClientFacingFloorsClimbedHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.floors_climbed.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingFloorsClimbedHistoricalPullCompleted
                && equalTo((ClientFacingFloorsClimbedHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingFloorsClimbedHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingFloorsClimbedHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingFloorsClimbedHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingFloorsClimbedHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingFloorsClimbedHistoricalPullCompleted build() {
            return new ClientFacingFloorsClimbedHistoricalPullCompleted(
