...
@JsonDeserialize(builder = ClientFacingStressLevelTimeseries.Builder.class)
public final class ClientFacingStressLevelTimeseries {
    ...
    private ClientFacingStressLevelTimeseries(
            Optional<Integer> id,
    ...
    /**
     * @return Measured in percentage (0-100).
     */
    @JsonProperty("unit")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingStressLevelTimeseries && equalTo((ClientFacingStressLevelTimeseries) other);
    }
    ...
    private boolean equalTo(ClientFacingStressLevelTimeseries other) {
    ...
    public interface UnitStage {
        ...
        Builder from(ClientFacingStressLevelTimeseries other);
    }
    ...
    public static final class Builder implements UnitStage, TimestampStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingStressLevelTimeseries other) {
            id(other.getId());
