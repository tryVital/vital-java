...
@JsonDeserialize(builder = ClientFacingWaistCircumferenceHistoricalPullCompleted.Builder.class)
public final class ClientFacingWaistCircumferenceHistoricalPullCompleted {
    ...
    private ClientFacingWaistCircumferenceHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.waist_circumference.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWaistCircumferenceHistoricalPullCompleted
                && equalTo((ClientFacingWaistCircumferenceHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWaistCircumferenceHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWaistCircumferenceHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWaistCircumferenceHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWaistCircumferenceHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWaistCircumferenceHistoricalPullCompleted build() {
            return new ClientFacingWaistCircumferenceHistoricalPullCompleted(
