...
@JsonDeserialize(builder = ClientFacingBasalBodyTemperatureHistoricalPullCompleted.Builder.class)
public final class ClientFacingBasalBodyTemperatureHistoricalPullCompleted {
    ...
    private ClientFacingBasalBodyTemperatureHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.basal_body_temperature.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBasalBodyTemperatureHistoricalPullCompleted
                && equalTo((ClientFacingBasalBodyTemperatureHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBasalBodyTemperatureHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBasalBodyTemperatureHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBasalBodyTemperatureHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBasalBodyTemperatureHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBasalBodyTemperatureHistoricalPullCompleted build() {
            return new ClientFacingBasalBodyTemperatureHistoricalPullCompleted(
