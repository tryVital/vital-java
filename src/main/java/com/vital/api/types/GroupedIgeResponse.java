...
public final class GroupedIgeResponse {
    ...
    private GroupedIgeResponse(
            Map<String, List<GroupedIge>> groups, Optional<String> next, Map<String, Object> additionalProperties) {
        this.groups = groups;
        this.next = next;
    ...
    public static final class Builder {
        ...
        public GroupedIgeResponse build() {
            return new GroupedIgeResponse(groups, next, additionalProperties);
        }
    }
}
