...
@JsonDeserialize(builder = ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted.Builder.class)
public final class ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted {
    ...
    private ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.peak_expiratory_flow_rate.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted
                && equalTo((ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted build() {
            return new ClientFacingPeakExpiratoryFlowRateHistoricalPullCompleted(
