...
@JsonDeserialize(builder = ClientFacingWheelchairPushHistoricalPullCompleted.Builder.class)
public final class ClientFacingWheelchairPushHistoricalPullCompleted {
    ...
    private ClientFacingWheelchairPushHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.wheelchair_push.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWheelchairPushHistoricalPullCompleted
                && equalTo((ClientFacingWheelchairPushHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWheelchairPushHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWheelchairPushHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWheelchairPushHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWheelchairPushHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWheelchairPushHistoricalPullCompleted build() {
            return new ClientFacingWheelchairPushHistoricalPullCompleted(
