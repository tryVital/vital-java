...
@JsonDeserialize(builder = ClientFacingAppointmentChanged.Builder.class)
public final class ClientFacingAppointmentChanged {
    private final ClientFacingAppointmentChangedEventType eventType;
    ...
    private ClientFacingAppointmentChanged(
            ClientFacingAppointmentChangedEventType eventType,
            String userId,
            String clientUserId,
            String teamId,
    ...
    public ClientFacingAppointmentChangedEventType getEventType() {
        return eventType;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingAppointmentChanged && equalTo((ClientFacingAppointmentChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingAppointmentChanged other) {
    ...
    public interface EventTypeStage {
        UserIdStage eventType(@NotNull ClientFacingAppointmentChangedEventType eventType);

        Builder from(ClientFacingAppointmentChanged other);
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull ClientFacingAppointment data);
    }

    public interface _FinalStage {
        ClientFacingAppointmentChanged build();
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder
            implements EventTypeStage, UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        private ClientFacingAppointmentChangedEventType eventType;
        ...
        @java.lang.Override
        public Builder from(ClientFacingAppointmentChanged other) {
        ...
        public UserIdStage eventType(@NotNull ClientFacingAppointmentChangedEventType eventType) {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull ClientFacingAppointment data) {
            this.data = Objects.requireNonNull(data, "data must not be null");
            return this;
        }

        @java.lang.Override
        public ClientFacingAppointmentChanged build() {
            return new ClientFacingAppointmentChanged(
