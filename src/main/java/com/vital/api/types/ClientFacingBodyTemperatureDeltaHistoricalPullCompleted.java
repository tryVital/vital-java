...
@JsonDeserialize(builder = ClientFacingBodyTemperatureDeltaHistoricalPullCompleted.Builder.class)
public final class ClientFacingBodyTemperatureDeltaHistoricalPullCompleted {
    ...
    private ClientFacingBodyTemperatureDeltaHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.body_temperature_delta.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBodyTemperatureDeltaHistoricalPullCompleted
                && equalTo((ClientFacingBodyTemperatureDeltaHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBodyTemperatureDeltaHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBodyTemperatureDeltaHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBodyTemperatureDeltaHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBodyTemperatureDeltaHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBodyTemperatureDeltaHistoricalPullCompleted build() {
            return new ClientFacingBodyTemperatureDeltaHistoricalPullCompleted(
