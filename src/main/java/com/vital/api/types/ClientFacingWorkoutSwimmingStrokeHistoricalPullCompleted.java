...
@JsonDeserialize(builder = ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted.Builder.class)
public final class ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted {
    ...
    private ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.workout_swimming_stroke.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted
                && equalTo((ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted build() {
            return new ClientFacingWorkoutSwimmingStrokeHistoricalPullCompleted(
