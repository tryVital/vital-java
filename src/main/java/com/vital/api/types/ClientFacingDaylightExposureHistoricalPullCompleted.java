...
@JsonDeserialize(builder = ClientFacingDaylightExposureHistoricalPullCompleted.Builder.class)
public final class ClientFacingDaylightExposureHistoricalPullCompleted {
    ...
    private ClientFacingDaylightExposureHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.daylight_exposure.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingDaylightExposureHistoricalPullCompleted
                && equalTo((ClientFacingDaylightExposureHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingDaylightExposureHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingDaylightExposureHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingDaylightExposureHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingDaylightExposureHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingDaylightExposureHistoricalPullCompleted build() {
            return new ClientFacingDaylightExposureHistoricalPullCompleted(
