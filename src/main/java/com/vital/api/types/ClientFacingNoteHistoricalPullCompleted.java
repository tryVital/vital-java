...
@JsonDeserialize(builder = ClientFacingNoteHistoricalPullCompleted.Builder.class)
public final class ClientFacingNoteHistoricalPullCompleted {
    ...
    private ClientFacingNoteHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.note.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingNoteHistoricalPullCompleted
                && equalTo((ClientFacingNoteHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingNoteHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingNoteHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingNoteHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingNoteHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingNoteHistoricalPullCompleted build() {
            return new ClientFacingNoteHistoricalPullCompleted(
