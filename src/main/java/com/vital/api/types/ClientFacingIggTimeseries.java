...
@JsonDeserialize(builder = ClientFacingIggTimeseries.Builder.class)
public final class ClientFacingIggTimeseries {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingIggTimeseries && equalTo((ClientFacingIggTimeseries) other);
    }

    private boolean equalTo(ClientFacingIggTimeseries other) {
    ...
    public interface _FinalStage {
        ClientFacingIggTimeseries build();
    ...
    public static final class Builder implements TimestampStage, ValueStage, UnitStage, _FinalStage {
        ...
        @Override
        public Builder from(ClientFacingIggTimeseries other) {
            id(other.getId());
        ...
        @Override
        public ClientFacingIggTimeseries build() {
            return new ClientFacingIggTimeseries(id, timestamp, timezoneOffset, value, type, unit);
        }
    }
}
