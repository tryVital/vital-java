...
@JsonDeserialize(builder = ClientFacingSleepCycleHistoricalPullCompleted.Builder.class)
public final class ClientFacingSleepCycleHistoricalPullCompleted {
    ...
    private ClientFacingSleepCycleHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.sleep_cycle.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingSleepCycleHistoricalPullCompleted
                && equalTo((ClientFacingSleepCycleHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingSleepCycleHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingSleepCycleHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingSleepCycleHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingSleepCycleHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingSleepCycleHistoricalPullCompleted build() {
            return new ClientFacingSleepCycleHistoricalPullCompleted(
