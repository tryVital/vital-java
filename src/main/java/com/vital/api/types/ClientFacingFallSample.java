...
@JsonDeserialize(builder = ClientFacingFallSample.Builder.class)
public final class ClientFacingFallSample {
    ...
    private ClientFacingFallSample(
            Optional<Integer> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingFallSample && equalTo((ClientFacingFallSample) other);
    }
    ...
    private boolean equalTo(ClientFacingFallSample other) {
    ...
    public interface TimestampStage {
        ...
        Builder from(ClientFacingFallSample other);
    }
    ...
    public static final class Builder implements TimestampStage, StartStage, EndStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingFallSample other) {
            id(other.getId());
        ...
        @java.lang.Override
        public ClientFacingFallSample build() {
            return new ClientFacingFallSample(
