...
public final class ClientFacingVo2MaxChanged {
    ...
    public interface EventTypeStage {
        UserIdStage eventType(ClientFacingVo2MaxChangedEventType eventType);
    ...
    public interface DataStage {
        _FinalStage data(GroupedVo2Max data);
    }
    ...
    public static final class Builder
        ...
        public UserIdStage eventType(ClientFacingVo2MaxChangedEventType eventType) {
            this.eventType = eventType;
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(GroupedVo2Max data) {
            this.data = data;
            return this;
        }
