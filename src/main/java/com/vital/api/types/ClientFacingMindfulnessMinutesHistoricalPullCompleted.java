...
@JsonDeserialize(builder = ClientFacingMindfulnessMinutesHistoricalPullCompleted.Builder.class)
public final class ClientFacingMindfulnessMinutesHistoricalPullCompleted {
    ...
    private ClientFacingMindfulnessMinutesHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.mindfulness_minutes.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingMindfulnessMinutesHistoricalPullCompleted
                && equalTo((ClientFacingMindfulnessMinutesHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingMindfulnessMinutesHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingMindfulnessMinutesHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingMindfulnessMinutesHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingMindfulnessMinutesHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingMindfulnessMinutesHistoricalPullCompleted build() {
            return new ClientFacingMindfulnessMinutesHistoricalPullCompleted(
