...
@JsonDeserialize(builder = ClientFacingBloodOxygenHistoricalPullCompleted.Builder.class)
public final class ClientFacingBloodOxygenHistoricalPullCompleted {
    ...
    private ClientFacingBloodOxygenHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.blood_oxygen.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBloodOxygenHistoricalPullCompleted
                && equalTo((ClientFacingBloodOxygenHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBloodOxygenHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBloodOxygenHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBloodOxygenHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBloodOxygenHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBloodOxygenHistoricalPullCompleted build() {
            return new ClientFacingBloodOxygenHistoricalPullCompleted(
