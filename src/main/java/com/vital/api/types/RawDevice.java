...
@JsonDeserialize(builder = RawDevice.Builder.class)
public final class RawDevice {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RawDevice && equalTo((RawDevice) other);
    }
    ...
    private boolean equalTo(RawDevice other) {
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Builder from(RawDevice other) {
            data(other.getData());
        ...
        public RawDevice build() {
            return new RawDevice(data, providerId, userId, sourceId, id, source, additionalProperties);
        }
