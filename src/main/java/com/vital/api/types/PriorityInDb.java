...
@JsonDeserialize(builder = PriorityInDb.Builder.class)
public final class PriorityInDb {
    ...
    private PriorityInDb(int id, int priority, String teamId, int sourceId, Optional<String> dataType) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PriorityInDb && equalTo((PriorityInDb) other);
    }

    private boolean equalTo(PriorityInDb other) {
        return id == other.id
    ...
    public interface IdStage {
        ...
        Builder from(PriorityInDb other);
    }
    ...
    public static final class Builder implements IdStage, PriorityStage, TeamIdStage, SourceIdStage, _FinalStage {
        ...
        @Override
        public Builder from(PriorityInDb other) {
            id(other.getId());
        ...
        @Override
        public PriorityInDb build() {
            return new PriorityInDb(id, priority, teamId, sourceId, dataType);
        }
    }
}
