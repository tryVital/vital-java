...
@JsonDeserialize(builder = ClientFacingBodyFatTimeseries.Builder.class)
public final class ClientFacingBodyFatTimeseries {
    ...
    private ClientFacingBodyFatTimeseries(
            Optional<Integer> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBodyFatTimeseries && equalTo((ClientFacingBodyFatTimeseries) other);
    }
    ...
    private boolean equalTo(ClientFacingBodyFatTimeseries other) {
    ...
    public interface UnitStage {
        ...
        Builder from(ClientFacingBodyFatTimeseries other);
    }
    ...
    public static final class Builder implements UnitStage, TimestampStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBodyFatTimeseries other) {
            id(other.getId());
        ...
        public ClientFacingBodyFatTimeseries build() {
            return new ClientFacingBodyFatTimeseries(
