...
@JsonDeserialize(builder = ClientFacingIgeChanged.Builder.class)
public final class ClientFacingIgeChanged {
    private final ClientFacingIgeChangedEventType eventType;
    ...
    private ClientFacingIgeChanged(
            ClientFacingIgeChangedEventType eventType,
            String userId,
            String clientUserId,
            String teamId,
            GroupedIge data,
    ...
    public ClientFacingIgeChangedEventType getEventType() {
        return eventType;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingIgeChanged && equalTo((ClientFacingIgeChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingIgeChanged other) {
    ...
    public interface EventTypeStage {
        UserIdStage eventType(ClientFacingIgeChangedEventType eventType);

        Builder from(ClientFacingIgeChanged other);
    }
    ...
    public interface DataStage {
        _FinalStage data(GroupedIge data);
    }
    ...
    public static final class Builder
        ...
        private ClientFacingIgeChangedEventType eventType;
        ...
        @java.lang.Override
        public Builder from(ClientFacingIgeChanged other) {
        ...
        public UserIdStage eventType(ClientFacingIgeChangedEventType eventType) {
            this.eventType = eventType;
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(GroupedIge data) {
            this.data = data;
            return this;
        }
