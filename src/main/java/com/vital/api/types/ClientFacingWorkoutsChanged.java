...
@JsonDeserialize(builder = ClientFacingWorkoutsChanged.Builder.class)
public final class ClientFacingWorkoutsChanged {
    private final ClientFacingWorkoutsChangedEventType eventType;
    ...
    private final ClientFacingWorkout data;

    private final Map<String, Object> additionalProperties;

    private ClientFacingWorkoutsChanged(
            ClientFacingWorkoutsChangedEventType eventType,
            String userId,
            String clientUserId,
            String teamId,
            ClientFacingWorkout data,
    ...
    public ClientFacingWorkoutsChangedEventType getEventType() {
        return eventType;
    }
    ...
    @JsonProperty("data")
    public ClientFacingWorkout getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWorkoutsChanged && equalTo((ClientFacingWorkoutsChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingWorkoutsChanged other) {
    ...
    public interface EventTypeStage {
        UserIdStage eventType(@NotNull ClientFacingWorkoutsChangedEventType eventType);

        Builder from(ClientFacingWorkoutsChanged other);
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull ClientFacingWorkout data);
    }
    ...
    public static final class Builder
        ...
        private ClientFacingWorkoutsChangedEventType eventType;
        ...
        private ClientFacingWorkout data;
        ...
        @java.lang.Override
        public Builder from(ClientFacingWorkoutsChanged other) {
        ...
        public UserIdStage eventType(@NotNull ClientFacingWorkoutsChangedEventType eventType) {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull ClientFacingWorkout data) {
