...
@JsonDeserialize(builder = ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted.Builder.class)
public final class ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted {
    ...
    private ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.heart_rate_recovery_one_minute.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted
                && equalTo((ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted build() {
            return new ClientFacingHeartRateRecoveryOneMinuteHistoricalPullCompleted(
