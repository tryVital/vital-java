...
@JsonDeserialize(builder = ClientFacingStandDurationHistoricalPullCompleted.Builder.class)
public final class ClientFacingStandDurationHistoricalPullCompleted {
    ...
    private ClientFacingStandDurationHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.stand_duration.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingStandDurationHistoricalPullCompleted
                && equalTo((ClientFacingStandDurationHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingStandDurationHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingStandDurationHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingStandDurationHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingStandDurationHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingStandDurationHistoricalPullCompleted build() {
            return new ClientFacingStandDurationHistoricalPullCompleted(
