...
public final class GroupedStepsResponse {
    ...
    private GroupedStepsResponse(
            Map<String, List<GroupedSteps>> groups, Optional<String> next, Map<String, Object> additionalProperties) {
        this.groups = groups;
        this.next = next;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedStepsResponse && equalTo((GroupedStepsResponse) other);
    }
    ...
    private boolean equalTo(GroupedStepsResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedStepsResponse other) {
        ...
        public GroupedStepsResponse build() {
            return new GroupedStepsResponse(groups, next, additionalProperties);
        }
    }
}
