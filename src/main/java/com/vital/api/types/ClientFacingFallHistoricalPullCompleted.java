...
@JsonDeserialize(builder = ClientFacingFallHistoricalPullCompleted.Builder.class)
public final class ClientFacingFallHistoricalPullCompleted {
    ...
    private ClientFacingFallHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.fall.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingFallHistoricalPullCompleted
                && equalTo((ClientFacingFallHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingFallHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingFallHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingFallHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingFallHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingFallHistoricalPullCompleted build() {
            return new ClientFacingFallHistoricalPullCompleted(
