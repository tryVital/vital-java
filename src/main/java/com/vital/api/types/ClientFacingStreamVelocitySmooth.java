...
public final class ClientFacingStreamVelocitySmooth {
    ...
    public static ClientFacingStreamVelocitySmooth ofListOfNullableDouble(List<Optional<Double>> value) {
        return new ClientFacingStreamVelocitySmooth(value, 0);
    }

    public static ClientFacingStreamVelocitySmooth ofListOfDouble(List<Double> value) {
