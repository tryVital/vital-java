...
@JsonDeserialize(builder = GroupedStressLevelResponse.Builder.class)
public final class GroupedStressLevelResponse {
    private final Map<String, List<GroupedStressLevel>> groups;
    ...
    private GroupedStressLevelResponse(
            Map<String, List<GroupedStressLevel>> groups,
     ...
     */
    @JsonProperty("groups")
    public Map<String, List<GroupedStressLevel>> getGroups() {
        return groups;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedStressLevelResponse && equalTo((GroupedStressLevelResponse) other);
    }
    ...
    private boolean equalTo(GroupedStressLevelResponse other) {
    ...
    public static final class Builder {
        private Map<String, List<GroupedStressLevel>> groups = new LinkedHashMap<>();
        ...
        public Builder from(GroupedStressLevelResponse other) {
        ...
        public Builder groups(Map<String, List<GroupedStressLevel>> groups) {
            this.groups.clear();
            this.groups.putAll(groups);
            return this;
        }

        public Builder putAllGroups(Map<String, List<GroupedStressLevel>> groups) {
            if (groups != null) {
                this.groups.putAll(groups);
            }
            return this;
        ...
        public Builder groups(String key, List<GroupedStressLevel> value) {
        ...
        public GroupedStressLevelResponse build() {
            return new GroupedStressLevelResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
