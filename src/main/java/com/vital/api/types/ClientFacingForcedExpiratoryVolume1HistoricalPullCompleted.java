...
@JsonDeserialize(builder = ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted.Builder.class)
public final class ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted {
    ...
    private ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.forced_expiratory_volume_1.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted
                && equalTo((ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted build() {
            return new ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted(
