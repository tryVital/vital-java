...
@JsonDeserialize(builder = ClientFacingHrvHistoricalPullCompleted.Builder.class)
public final class ClientFacingHrvHistoricalPullCompleted {
    ...
    private ClientFacingHrvHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.hrv.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingHrvHistoricalPullCompleted
                && equalTo((ClientFacingHrvHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingHrvHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingHrvHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingHrvHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingHrvHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingHrvHistoricalPullCompleted build() {
            return new ClientFacingHrvHistoricalPullCompleted(userId, clientUserId, teamId, data, additionalProperties);
        }
    }
}
