...
@JsonDeserialize(builder = ClientFacingSleepHistoricalPullCompleted.Builder.class)
public final class ClientFacingSleepHistoricalPullCompleted {
    ...
    private ClientFacingSleepHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.sleep.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingSleepHistoricalPullCompleted
                && equalTo((ClientFacingSleepHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingSleepHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingSleepHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingSleepHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingSleepHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingSleepHistoricalPullCompleted build() {
            return new ClientFacingSleepHistoricalPullCompleted(
