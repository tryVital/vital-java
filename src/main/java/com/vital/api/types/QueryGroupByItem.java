...
public final class QueryGroupByItem {
    ...
    public static QueryGroupByItem of(DerivedReadinessColumnExpr value) {
    ...
    public static QueryGroupByItem of(MenstrualCycleColumnExpr value) {
    ...
    public static QueryGroupByItem of(AwakeningsValueMacroExpr value) {
    ...
    public static QueryGroupByItem of(InsulinInjectionTimeseriesExpr value) {
