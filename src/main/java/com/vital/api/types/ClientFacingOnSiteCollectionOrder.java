...
@JsonDeserialize(builder = ClientFacingOnSiteCollectionOrder.Builder.class)
public final class ClientFacingOnSiteCollectionOrder {
    ...
    private ClientFacingOnSiteCollectionOrder(
    ...
    /**
     * @return The Junction on-site collection Order ID
     */
    @JsonProperty("id")
    public String getId() {
        return id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingOnSiteCollectionOrder && equalTo((ClientFacingOnSiteCollectionOrder) other);
    }
    ...
    private boolean equalTo(ClientFacingOnSiteCollectionOrder other) {
    ...
    public interface IdStage {
        ...
        Builder from(ClientFacingOnSiteCollectionOrder other);
    }
    ...
    public static final class Builder implements IdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingOnSiteCollectionOrder other) {
            id(other.getId());
