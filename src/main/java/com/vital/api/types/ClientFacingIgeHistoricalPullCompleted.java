...
@JsonDeserialize(builder = ClientFacingIgeHistoricalPullCompleted.Builder.class)
public final class ClientFacingIgeHistoricalPullCompleted {
    ...
    private ClientFacingIgeHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.ige.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingIgeHistoricalPullCompleted
                && equalTo((ClientFacingIgeHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingIgeHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingIgeHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingIgeHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingIgeHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingIgeHistoricalPullCompleted build() {
            return new ClientFacingIgeHistoricalPullCompleted(userId, clientUserId, teamId, data, additionalProperties);
        }
    }
}
