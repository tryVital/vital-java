...
@JsonDeserialize(builder = ClientFacingBodyTemperatureHistoricalPullCompleted.Builder.class)
public final class ClientFacingBodyTemperatureHistoricalPullCompleted {
    ...
    private ClientFacingBodyTemperatureHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.body_temperature.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBodyTemperatureHistoricalPullCompleted
                && equalTo((ClientFacingBodyTemperatureHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBodyTemperatureHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBodyTemperatureHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBodyTemperatureHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBodyTemperatureHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBodyTemperatureHistoricalPullCompleted build() {
            return new ClientFacingBodyTemperatureHistoricalPullCompleted(
