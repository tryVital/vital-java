...
@JsonDeserialize(builder = ClientFacingStressLevelHistoricalPullCompleted.Builder.class)
public final class ClientFacingStressLevelHistoricalPullCompleted {
    ...
    private ClientFacingStressLevelHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.stress_level.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingStressLevelHistoricalPullCompleted
                && equalTo((ClientFacingStressLevelHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingStressLevelHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingStressLevelHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingStressLevelHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingStressLevelHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingStressLevelHistoricalPullCompleted build() {
            return new ClientFacingStressLevelHistoricalPullCompleted(
