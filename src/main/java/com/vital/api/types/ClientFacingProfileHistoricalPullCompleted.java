...
@JsonDeserialize(builder = ClientFacingProfileHistoricalPullCompleted.Builder.class)
public final class ClientFacingProfileHistoricalPullCompleted {
    ...
    private ClientFacingProfileHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.profile.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingProfileHistoricalPullCompleted
                && equalTo((ClientFacingProfileHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingProfileHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingProfileHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingProfileHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingProfileHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingProfileHistoricalPullCompleted build() {
            return new ClientFacingProfileHistoricalPullCompleted(
