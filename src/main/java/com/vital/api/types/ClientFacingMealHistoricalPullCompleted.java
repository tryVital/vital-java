...
@JsonDeserialize(builder = ClientFacingMealHistoricalPullCompleted.Builder.class)
public final class ClientFacingMealHistoricalPullCompleted {
    ...
    private ClientFacingMealHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.meal.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingMealHistoricalPullCompleted
                && equalTo((ClientFacingMealHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingMealHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingMealHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingMealHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingMealHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingMealHistoricalPullCompleted build() {
            return new ClientFacingMealHistoricalPullCompleted(
