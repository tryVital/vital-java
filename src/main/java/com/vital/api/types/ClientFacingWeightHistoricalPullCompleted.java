...
@JsonDeserialize(builder = ClientFacingWeightHistoricalPullCompleted.Builder.class)
public final class ClientFacingWeightHistoricalPullCompleted {
    ...
    private ClientFacingWeightHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.weight.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWeightHistoricalPullCompleted
                && equalTo((ClientFacingWeightHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWeightHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWeightHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWeightHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWeightHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWeightHistoricalPullCompleted build() {
            return new ClientFacingWeightHistoricalPullCompleted(
