...
public final class GroupedHeartRateRecoveryOneMinuteResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GroupedHeartRateRecoveryOneMinuteResponse
                && equalTo((GroupedHeartRateRecoveryOneMinuteResponse) other);
    }
    ...
    private boolean equalTo(GroupedHeartRateRecoveryOneMinuteResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedHeartRateRecoveryOneMinuteResponse other) {
        ...
        public GroupedHeartRateRecoveryOneMinuteResponse build() {
            return new GroupedHeartRateRecoveryOneMinuteResponse(groups, next, nextCursor, additionalProperties);
        }
    }
}
