...
public final class GroupedIggResponse {
    ...
    private GroupedIggResponse(
            Map<String, List<GroupedIgg>> groups, Optional<String> next, Map<String, Object> additionalProperties) {
        this.groups = groups;
        this.next = next;
    ...
    private boolean equalTo(GroupedIggResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GroupedIggResponse other) {
        ...
        public GroupedIggResponse build() {
            return new GroupedIggResponse(groups, next, additionalProperties);
        }
    }
}
