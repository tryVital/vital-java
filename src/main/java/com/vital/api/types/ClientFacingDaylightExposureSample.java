...
@JsonDeserialize(builder = ClientFacingDaylightExposureSample.Builder.class)
public final class ClientFacingDaylightExposureSample {
    ...
    private ClientFacingDaylightExposureSample(
            Optional<Integer> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingDaylightExposureSample
                && equalTo((ClientFacingDaylightExposureSample) other);
    }
    ...
    private boolean equalTo(ClientFacingDaylightExposureSample other) {
    ...
    public interface TimestampStage {
        ...
        Builder from(ClientFacingDaylightExposureSample other);
    }
    ...
    public static final class Builder implements TimestampStage, StartStage, EndStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingDaylightExposureSample other) {
            id(other.getId());
