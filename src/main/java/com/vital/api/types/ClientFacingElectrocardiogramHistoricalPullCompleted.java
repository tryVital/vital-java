...
@JsonDeserialize(builder = ClientFacingElectrocardiogramHistoricalPullCompleted.Builder.class)
public final class ClientFacingElectrocardiogramHistoricalPullCompleted {
    ...
    private ClientFacingElectrocardiogramHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.electrocardiogram.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingElectrocardiogramHistoricalPullCompleted
                && equalTo((ClientFacingElectrocardiogramHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingElectrocardiogramHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingElectrocardiogramHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingElectrocardiogramHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingElectrocardiogramHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingElectrocardiogramHistoricalPullCompleted build() {
            return new ClientFacingElectrocardiogramHistoricalPullCompleted(
