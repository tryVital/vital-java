...
@JsonDeserialize(builder = ClientFacingStepsHistoricalPullCompleted.Builder.class)
public final class ClientFacingStepsHistoricalPullCompleted {
    ...
    private ClientFacingStepsHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.steps.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingStepsHistoricalPullCompleted
                && equalTo((ClientFacingStepsHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingStepsHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingStepsHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingStepsHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingStepsHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingStepsHistoricalPullCompleted build() {
            return new ClientFacingStepsHistoricalPullCompleted(
