...
@JsonDeserialize(builder = ClientFacingWorkoutDistanceHistoricalPullCompleted.Builder.class)
public final class ClientFacingWorkoutDistanceHistoricalPullCompleted {
    ...
    private ClientFacingWorkoutDistanceHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.workout_distance.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingWorkoutDistanceHistoricalPullCompleted
                && equalTo((ClientFacingWorkoutDistanceHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingWorkoutDistanceHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingWorkoutDistanceHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingWorkoutDistanceHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingWorkoutDistanceHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingWorkoutDistanceHistoricalPullCompleted build() {
            return new ClientFacingWorkoutDistanceHistoricalPullCompleted(
