...
@JsonDeserialize(builder = ClientFacingForcedExpiratoryVolume1Sample.Builder.class)
public final class ClientFacingForcedExpiratoryVolume1Sample {
    ...
    private ClientFacingForcedExpiratoryVolume1Sample(
            Optional<Integer> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingForcedExpiratoryVolume1Sample
                && equalTo((ClientFacingForcedExpiratoryVolume1Sample) other);
    }
    ...
    private boolean equalTo(ClientFacingForcedExpiratoryVolume1Sample other) {
    ...
    public interface TimestampStage {
        ...
        Builder from(ClientFacingForcedExpiratoryVolume1Sample other);
    }
    ...
    public static final class Builder implements TimestampStage, StartStage, EndStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingForcedExpiratoryVolume1Sample other) {
            id(other.getId());
