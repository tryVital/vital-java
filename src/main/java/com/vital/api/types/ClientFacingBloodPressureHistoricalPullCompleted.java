...
@JsonDeserialize(builder = ClientFacingBloodPressureHistoricalPullCompleted.Builder.class)
public final class ClientFacingBloodPressureHistoricalPullCompleted {
    ...
    private ClientFacingBloodPressureHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.blood_pressure.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingBloodPressureHistoricalPullCompleted
                && equalTo((ClientFacingBloodPressureHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingBloodPressureHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingBloodPressureHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingBloodPressureHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingBloodPressureHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingBloodPressureHistoricalPullCompleted build() {
            return new ClientFacingBloodPressureHistoricalPullCompleted(
