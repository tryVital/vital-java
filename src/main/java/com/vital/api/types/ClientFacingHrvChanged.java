...
@JsonDeserialize(builder = ClientFacingHrvChanged.Builder.class)
public final class ClientFacingHrvChanged {
    private final ClientFacingHrvChangedEventType eventType;
    ...
    private ClientFacingHrvChanged(
            ClientFacingHrvChangedEventType eventType,
            String userId,
            String clientUserId,
            String teamId,
            GroupedHrv data,
    ...
    public ClientFacingHrvChangedEventType getEventType() {
        return eventType;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingHrvChanged && equalTo((ClientFacingHrvChanged) other);
    }
    ...
    private boolean equalTo(ClientFacingHrvChanged other) {
    ...
    public interface EventTypeStage {
        UserIdStage eventType(ClientFacingHrvChangedEventType eventType);

        Builder from(ClientFacingHrvChanged other);
    }
    ...
    public interface DataStage {
        _FinalStage data(GroupedHrv data);
    }
    ...
    public static final class Builder
        ...
        private ClientFacingHrvChangedEventType eventType;
        ...
        @java.lang.Override
        public Builder from(ClientFacingHrvChanged other) {
        ...
        public UserIdStage eventType(ClientFacingHrvChangedEventType eventType) {
            this.eventType = eventType;
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(GroupedHrv data) {
            this.data = data;
            return this;
        }
