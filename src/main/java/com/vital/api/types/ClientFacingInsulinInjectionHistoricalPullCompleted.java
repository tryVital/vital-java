...
@JsonDeserialize(builder = ClientFacingInsulinInjectionHistoricalPullCompleted.Builder.class)
public final class ClientFacingInsulinInjectionHistoricalPullCompleted {
    ...
    private ClientFacingInsulinInjectionHistoricalPullCompleted(
            String userId,
            String clientUserId,
            String teamId,
    ...
    public String getEventType() {
        return "historical.data.insulin_injection.created";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientFacingInsulinInjectionHistoricalPullCompleted
                && equalTo((ClientFacingInsulinInjectionHistoricalPullCompleted) other);
    }
    ...
    private boolean equalTo(ClientFacingInsulinInjectionHistoricalPullCompleted other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(ClientFacingInsulinInjectionHistoricalPullCompleted other);
    }
    ...
    public interface _FinalStage {
        ClientFacingInsulinInjectionHistoricalPullCompleted build();
    }
    ...
    public static final class Builder implements UserIdStage, ClientUserIdStage, TeamIdStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ClientFacingInsulinInjectionHistoricalPullCompleted other) {
        ...
        @java.lang.Override
        public ClientFacingInsulinInjectionHistoricalPullCompleted build() {
            return new ClientFacingInsulinInjectionHistoricalPullCompleted(
