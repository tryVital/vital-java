...
public final class PhysicianCreateRequestSignatureImage {
    ...
    private PhysicianCreateRequestSignatureImage(Value value) {
        this.value = value;
    }
    ...
    public static PhysicianCreateRequestSignatureImage imageJpeg(Jpeg value) {
        return new PhysicianCreateRequestSignatureImage(new ImageJpegValue(value));
    }

    public static PhysicianCreateRequestSignatureImage imagePng(Png value) {
        return new PhysicianCreateRequestSignatureImage(new ImagePngValue(value));
    }
    ...
    private static final class ImageJpegValue implements Value {
        ...
        public String toString() {
            return "PhysicianCreateRequestSignatureImage{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @Override
        public String toString() {
            return "PhysicianCreateRequestSignatureImage{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
