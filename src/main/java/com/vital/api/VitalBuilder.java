...
public class VitalBuilder {
     ...
     */
    public VitalBuilder timeout(int timeout) {
     ...
     */
    public VitalBuilder maxRetries(int maxRetries) {
     ...
     */
    public VitalBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public VitalBuilder logging(LogConfig logging) {
     ...
     */
    public VitalBuilder addHeader(String name, String value) {
    ...
    public Vital build() {
        ...
        return new Vital(buildClientOptions());
    }
}
