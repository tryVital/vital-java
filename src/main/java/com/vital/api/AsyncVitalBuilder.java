...
import com.vital.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncVitalBuilder {
     ...
     * Sets apiKey
     */
    public AsyncVitalBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncVitalBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncVitalBuilder url(String url) {
     ...
     */
    public AsyncVitalBuilder timeout(int timeout) {
     ...
     */
    public AsyncVitalBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncVitalBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncVitalBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncVitalBuilder addHeader(String name, String value) {
     ...
     */
    protected void setAuthentication(ClientOptions.Builder builder) {
        builder.addHeader("x-vital-api-key", this.apiKey);
    }
    ...
    public AsyncVital build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncVital(buildClientOptions());
    }
}
