 ...
 */
package com.vital.api.resources.meal.requests;
...
@JsonDeserialize(builder = GetMealRequest.Builder.class)
public final class GetMealRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetMealRequest && equalTo((GetMealRequest) other);
    }
    ...
    private boolean equalTo(GetMealRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetMealRequest other);
    }

    public interface _FinalStage {
        GetMealRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetMealRequest other) {
        ...
        @java.lang.Override
        public GetMealRequest build() {
            return new GetMealRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
