...
public final class DevicesGetRawRequest {
    ...
    private DevicesGetRawRequest(Optional<String> provider, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public DevicesGetRawRequest build() {
            return new DevicesGetRawRequest(provider, additionalProperties);
        }
    }
}
