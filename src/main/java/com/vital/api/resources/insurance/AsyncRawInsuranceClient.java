...
public class AsyncRawInsuranceClient {
    ...
    public CompletableFuture<VitalHttpResponse<List<ClientFacingPayorSearchResponse>>> searchGetPayorInfo(
        ...
        CompletableFuture<VitalHttpResponse<List<ClientFacingPayorSearchResponse>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<VitalHttpResponse<List<ClientFacingPayorSearchResponseDeprecated>>> searchPayorInfo(
        ...
        CompletableFuture<VitalHttpResponse<List<ClientFacingPayorSearchResponseDeprecated>>> future =
    ...
    public CompletableFuture<VitalHttpResponse<List<ClientFacingDiagnosisInformation>>> searchDiagnosis(
        ...
        CompletableFuture<VitalHttpResponse<List<ClientFacingDiagnosisInformation>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
