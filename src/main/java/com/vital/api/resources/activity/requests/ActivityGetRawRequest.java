...
@JsonDeserialize(builder = ActivityGetRawRequest.Builder.class)
public final class ActivityGetRawRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActivityGetRawRequest && equalTo((ActivityGetRawRequest) other);
    }
    ...
    private boolean equalTo(ActivityGetRawRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(ActivityGetRawRequest other);
    }
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(ActivityGetRawRequest other) {
        ...
        public ActivityGetRawRequest build() {
            return new ActivityGetRawRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
