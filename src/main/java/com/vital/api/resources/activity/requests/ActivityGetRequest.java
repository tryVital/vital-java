...
@JsonDeserialize(builder = ActivityGetRequest.Builder.class)
public final class ActivityGetRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActivityGetRequest && equalTo((ActivityGetRequest) other);
    }
    ...
    private boolean equalTo(ActivityGetRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(ActivityGetRequest other);
    }

    public interface _FinalStage {
        ActivityGetRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ActivityGetRequest other) {
        ...
        public ActivityGetRequest build() {
            return new ActivityGetRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
