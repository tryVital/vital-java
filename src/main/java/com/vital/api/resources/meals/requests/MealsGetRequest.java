package com.vital.api.resources.meals.requests;
...
@JsonDeserialize(builder = MealsGetRequest.Builder.class)
public final class MealsGetRequest {
    ...
    private MealsGetRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MealsGetRequest && equalTo((MealsGetRequest) other);
    }

    private boolean equalTo(MealsGetRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(MealsGetRequest other);
    }

    public interface _FinalStage {
        MealsGetRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(MealsGetRequest other) {
        ...
        @Override
        public MealsGetRequest build() {
            return new MealsGetRequest(provider, startDate, endDate);
        }
    }
}
