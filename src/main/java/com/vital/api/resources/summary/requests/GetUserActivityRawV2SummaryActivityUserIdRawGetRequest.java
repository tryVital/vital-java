...
@JsonDeserialize(builder = GetUserActivityRawV2SummaryActivityUserIdRawGetRequest.Builder.class)
public final class GetUserActivityRawV2SummaryActivityUserIdRawGetRequest {
    ...
    private GetUserActivityRawV2SummaryActivityUserIdRawGetRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetUserActivityRawV2SummaryActivityUserIdRawGetRequest
                && equalTo((GetUserActivityRawV2SummaryActivityUserIdRawGetRequest) other);
    }

    private boolean equalTo(GetUserActivityRawV2SummaryActivityUserIdRawGetRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetUserActivityRawV2SummaryActivityUserIdRawGetRequest other);
    }

    public interface _FinalStage {
        GetUserActivityRawV2SummaryActivityUserIdRawGetRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(GetUserActivityRawV2SummaryActivityUserIdRawGetRequest other) {
        ...
        @Override
        public GetUserActivityRawV2SummaryActivityUserIdRawGetRequest build() {
            return new GetUserActivityRawV2SummaryActivityUserIdRawGetRequest(provider, startDate, endDate);
        }
    }
}
