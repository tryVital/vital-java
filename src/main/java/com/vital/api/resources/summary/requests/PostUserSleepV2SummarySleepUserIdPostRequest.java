...
@JsonDeserialize(builder = PostUserSleepV2SummarySleepUserIdPostRequest.Builder.class)
public final class PostUserSleepV2SummarySleepUserIdPostRequest {
    private final Optional<String> vitalIosSdkVersion;

    private final Optional<String> vitalAndroidSdkVersion;

    private PostUserSleepV2SummarySleepUserIdPostRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostUserSleepV2SummarySleepUserIdPostRequest
                && equalTo((PostUserSleepV2SummarySleepUserIdPostRequest) other);
    }

    private boolean equalTo(PostUserSleepV2SummarySleepUserIdPostRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PostUserSleepV2SummarySleepUserIdPostRequest other) {
        ...
        public PostUserSleepV2SummarySleepUserIdPostRequest build() {
            return new PostUserSleepV2SummarySleepUserIdPostRequest(vitalIosSdkVersion, vitalAndroidSdkVersion);
        }
    }
}
