...
@JsonDeserialize(builder = BodyGetRawRequest.Builder.class)
public final class BodyGetRawRequest {
    ...
    private BodyGetRawRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BodyGetRawRequest && equalTo((BodyGetRawRequest) other);
    }

    private boolean equalTo(BodyGetRawRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(BodyGetRawRequest other);
    }
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(BodyGetRawRequest other) {
        ...
        public BodyGetRawRequest build() {
            return new BodyGetRawRequest(provider, startDate, endDate);
        }
    }
}
