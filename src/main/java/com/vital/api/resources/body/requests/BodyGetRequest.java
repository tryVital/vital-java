package com.vital.api.resources.body.requests;
...
@JsonDeserialize(builder = BodyGetRequest.Builder.class)
public final class BodyGetRequest {
    ...
    private BodyGetRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BodyGetRequest && equalTo((BodyGetRequest) other);
    }

    private boolean equalTo(BodyGetRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(BodyGetRequest other);
    }

    public interface _FinalStage {
        BodyGetRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(BodyGetRequest other) {
        ...
        @Override
        public BodyGetRequest build() {
            return new BodyGetRequest(provider, startDate, endDate);
        }
    }
}
