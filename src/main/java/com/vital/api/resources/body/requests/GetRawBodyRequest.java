...
@JsonDeserialize(builder = GetRawBodyRequest.Builder.class)
public final class GetRawBodyRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetRawBodyRequest && equalTo((GetRawBodyRequest) other);
    }
    ...
    private boolean equalTo(GetRawBodyRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetRawBodyRequest other);
    }

    public interface _FinalStage {
        GetRawBodyRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetRawBodyRequest other) {
        ...
        @java.lang.Override
        public GetRawBodyRequest build() {
            return new GetRawBodyRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
