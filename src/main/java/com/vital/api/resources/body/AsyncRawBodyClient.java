...
public class AsyncRawBodyClient {
    protected final ClientOptions clientOptions;

    public AsyncRawBodyClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<VitalHttpResponse<ClientBodyResponse>> get(
        ...
        CompletableFuture<VitalHttpResponse<ClientBodyResponse>> future = new CompletableFuture<>();
