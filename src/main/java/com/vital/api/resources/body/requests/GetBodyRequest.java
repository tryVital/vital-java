...
@JsonDeserialize(builder = GetBodyRequest.Builder.class)
public final class GetBodyRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetBodyRequest && equalTo((GetBodyRequest) other);
    }
    ...
    private boolean equalTo(GetBodyRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetBodyRequest other);
    }

    public interface _FinalStage {
        GetBodyRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetBodyRequest other) {
        ...
        @java.lang.Override
        public GetBodyRequest build() {
            return new GetBodyRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
