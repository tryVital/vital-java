...
@JsonDeserialize(builder = SleepGetRequest.Builder.class)
public final class SleepGetRequest {
    ...
    private SleepGetRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SleepGetRequest && equalTo((SleepGetRequest) other);
    }

    private boolean equalTo(SleepGetRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(SleepGetRequest other);
    }
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(SleepGetRequest other) {
        ...
        public SleepGetRequest build() {
            return new SleepGetRequest(provider, startDate, endDate);
        }
    }
}
