...
@JsonDeserialize(builder = GetRawSleepRequest.Builder.class)
public final class GetRawSleepRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetRawSleepRequest && equalTo((GetRawSleepRequest) other);
    }
    ...
    private boolean equalTo(GetRawSleepRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetRawSleepRequest other);
    }

    public interface _FinalStage {
        GetRawSleepRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetRawSleepRequest other) {
        ...
        @java.lang.Override
        public GetRawSleepRequest build() {
            return new GetRawSleepRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
