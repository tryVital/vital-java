...
@JsonDeserialize(builder = SleepGetUserStreamRequest.Builder.class)
public final class SleepGetUserStreamRequest {
    ...
    private SleepGetUserStreamRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SleepGetUserStreamRequest && equalTo((SleepGetUserStreamRequest) other);
    }

    private boolean equalTo(SleepGetUserStreamRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(SleepGetUserStreamRequest other);
    }

    public interface _FinalStage {
        SleepGetUserStreamRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(SleepGetUserStreamRequest other) {
        ...
        @Override
        public SleepGetUserStreamRequest build() {
            return new SleepGetUserStreamRequest(provider, startDate, endDate);
        }
    }
}
