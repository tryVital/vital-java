...
@JsonDeserialize(builder = GetSleepRequest.Builder.class)
public final class GetSleepRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetSleepRequest && equalTo((GetSleepRequest) other);
    }
    ...
    private boolean equalTo(GetSleepRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetSleepRequest other);
    }

    public interface _FinalStage {
        GetSleepRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetSleepRequest other) {
        ...
        @java.lang.Override
        public GetSleepRequest build() {
            return new GetSleepRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
