...
@JsonDeserialize(builder = VitalsHeartrateRequest.Builder.class)
public final class VitalsHeartrateRequest {
    ...
    private VitalsHeartrateRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsHeartrateRequest && equalTo((VitalsHeartrateRequest) other);
    }

    private boolean equalTo(VitalsHeartrateRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsHeartrateRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsHeartrateRequest other) {
        ...
        @Override
        public VitalsHeartrateRequest build() {
            return new VitalsHeartrateRequest(resource, provider, startDate, endDate);
        }
    }
}
