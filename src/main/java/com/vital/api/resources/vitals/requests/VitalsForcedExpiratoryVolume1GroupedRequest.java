...
@JsonDeserialize(builder = VitalsForcedExpiratoryVolume1GroupedRequest.Builder.class)
public final class VitalsForcedExpiratoryVolume1GroupedRequest {
    ...
    private VitalsForcedExpiratoryVolume1GroupedRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsForcedExpiratoryVolume1GroupedRequest
                && equalTo((VitalsForcedExpiratoryVolume1GroupedRequest) other);
    }
    ...
    private boolean equalTo(VitalsForcedExpiratoryVolume1GroupedRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(VitalsForcedExpiratoryVolume1GroupedRequest other);
    }

    public interface _FinalStage {
        VitalsForcedExpiratoryVolume1GroupedRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(VitalsForcedExpiratoryVolume1GroupedRequest other) {
        ...
        @java.lang.Override
        public VitalsForcedExpiratoryVolume1GroupedRequest build() {
            return new VitalsForcedExpiratoryVolume1GroupedRequest(
