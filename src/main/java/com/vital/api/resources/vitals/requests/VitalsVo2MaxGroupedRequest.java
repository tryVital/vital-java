...
@JsonDeserialize(builder = VitalsVo2MaxGroupedRequest.Builder.class)
public final class VitalsVo2MaxGroupedRequest {
    ...
    private VitalsVo2MaxGroupedRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsVo2MaxGroupedRequest && equalTo((VitalsVo2MaxGroupedRequest) other);
    }
    ...
    private boolean equalTo(VitalsVo2MaxGroupedRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(VitalsVo2MaxGroupedRequest other);
    }

    public interface _FinalStage {
        VitalsVo2MaxGroupedRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsVo2MaxGroupedRequest other) {
        ...
        @Override
        public VitalsVo2MaxGroupedRequest build() {
            return new VitalsVo2MaxGroupedRequest(cursor, provider, startDate, endDate, additionalProperties);
        }
    }
}
