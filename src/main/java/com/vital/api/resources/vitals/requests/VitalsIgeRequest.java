...
@JsonDeserialize(builder = VitalsIgeRequest.Builder.class)
public final class VitalsIgeRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsIgeRequest && equalTo((VitalsIgeRequest) other);
    }

    private boolean equalTo(VitalsIgeRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsIgeRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsIgeRequest other) {
        ...
        @Override
        public VitalsIgeRequest build() {
            return new VitalsIgeRequest(resource, provider, startDate, endDate);
        }
    }
}
