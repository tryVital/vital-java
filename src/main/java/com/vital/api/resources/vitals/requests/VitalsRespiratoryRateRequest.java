...
@JsonDeserialize(builder = VitalsRespiratoryRateRequest.Builder.class)
public final class VitalsRespiratoryRateRequest {
    ...
    private VitalsRespiratoryRateRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsRespiratoryRateRequest && equalTo((VitalsRespiratoryRateRequest) other);
    }

    private boolean equalTo(VitalsRespiratoryRateRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsRespiratoryRateRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsRespiratoryRateRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsRespiratoryRateRequest other) {
        ...
        @Override
        public VitalsRespiratoryRateRequest build() {
            return new VitalsRespiratoryRateRequest(resource, provider, startDate, endDate);
        }
    }
}
