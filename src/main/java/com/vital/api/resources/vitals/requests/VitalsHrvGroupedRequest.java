...
public final class VitalsHrvGroupedRequest {
    ...
    private VitalsHrvGroupedRequest(
    ...
    private boolean equalTo(VitalsHrvGroupedRequest other) {
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        public VitalsHrvGroupedRequest build() {
            return new VitalsHrvGroupedRequest(cursor, provider, startDate, endDate, additionalProperties);
        }
    }
}
