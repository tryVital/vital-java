...
@JsonDeserialize(builder = VitalsHypnogramRequest.Builder.class)
public final class VitalsHypnogramRequest {
    ...
    private VitalsHypnogramRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsHypnogramRequest && equalTo((VitalsHypnogramRequest) other);
    }

    private boolean equalTo(VitalsHypnogramRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsHypnogramRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsHypnogramRequest other) {
        ...
        @Override
        public VitalsHypnogramRequest build() {
            return new VitalsHypnogramRequest(resource, provider, startDate, endDate);
        }
    }
}
