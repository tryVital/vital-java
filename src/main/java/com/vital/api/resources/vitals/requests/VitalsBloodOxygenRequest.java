...
@JsonDeserialize(builder = VitalsBloodOxygenRequest.Builder.class)
public final class VitalsBloodOxygenRequest {
    ...
    private VitalsBloodOxygenRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsBloodOxygenRequest && equalTo((VitalsBloodOxygenRequest) other);
    }

    private boolean equalTo(VitalsBloodOxygenRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsBloodOxygenRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsBloodOxygenRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsBloodOxygenRequest other) {
        ...
        @Override
        public VitalsBloodOxygenRequest build() {
            return new VitalsBloodOxygenRequest(resource, provider, startDate, endDate);
        }
    }
}
