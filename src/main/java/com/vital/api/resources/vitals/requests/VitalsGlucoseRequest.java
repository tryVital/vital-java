...
@JsonDeserialize(builder = VitalsGlucoseRequest.Builder.class)
public final class VitalsGlucoseRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsGlucoseRequest && equalTo((VitalsGlucoseRequest) other);
    }

    private boolean equalTo(VitalsGlucoseRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsGlucoseRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsGlucoseRequest other) {
        ...
        @Override
        public VitalsGlucoseRequest build() {
            return new VitalsGlucoseRequest(resource, provider, startDate, endDate);
        }
    }
}
