...
@JsonDeserialize(builder = VitalsCholesterolLdlRequest.Builder.class)
public final class VitalsCholesterolLdlRequest {
    ...
    private VitalsCholesterolLdlRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCholesterolLdlRequest && equalTo((VitalsCholesterolLdlRequest) other);
    }

    private boolean equalTo(VitalsCholesterolLdlRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCholesterolLdlRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsCholesterolLdlRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCholesterolLdlRequest other) {
        ...
        @Override
        public VitalsCholesterolLdlRequest build() {
            return new VitalsCholesterolLdlRequest(resource, provider, startDate, endDate);
        }
    }
}
