...
@JsonDeserialize(builder = VitalsCaffeineGroupedRequest.Builder.class)
public final class VitalsCaffeineGroupedRequest {
    ...
    private VitalsCaffeineGroupedRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCaffeineGroupedRequest && equalTo((VitalsCaffeineGroupedRequest) other);
    }
    ...
    private boolean equalTo(VitalsCaffeineGroupedRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(VitalsCaffeineGroupedRequest other);
    }
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCaffeineGroupedRequest other) {
        ...
        public VitalsCaffeineGroupedRequest build() {
            return new VitalsCaffeineGroupedRequest(cursor, provider, startDate, endDate, additionalProperties);
        }
    }
}
