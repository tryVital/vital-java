...
@JsonDeserialize(builder = VitalsIggRequest.Builder.class)
public final class VitalsIggRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsIggRequest && equalTo((VitalsIggRequest) other);
    }

    private boolean equalTo(VitalsIggRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsIggRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsIggRequest other) {
        ...
        public VitalsIggRequest build() {
            return new VitalsIggRequest(resource, provider, startDate, endDate);
        }
    }
}
