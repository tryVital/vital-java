...
@JsonDeserialize(builder = IgeVitalsRequest.Builder.class)
public final class IgeVitalsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IgeVitalsRequest && equalTo((IgeVitalsRequest) other);
    }
    ...
    private boolean equalTo(IgeVitalsRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(IgeVitalsRequest other);
    }

    public interface _FinalStage {
        IgeVitalsRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(IgeVitalsRequest other) {
        ...
        @java.lang.Override
        public IgeVitalsRequest build() {
            return new IgeVitalsRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
