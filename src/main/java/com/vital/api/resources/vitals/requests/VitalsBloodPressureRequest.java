...
@JsonDeserialize(builder = VitalsBloodPressureRequest.Builder.class)
public final class VitalsBloodPressureRequest {
    ...
    private VitalsBloodPressureRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsBloodPressureRequest && equalTo((VitalsBloodPressureRequest) other);
    }

    private boolean equalTo(VitalsBloodPressureRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsBloodPressureRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsBloodPressureRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsBloodPressureRequest other) {
        ...
        @Override
        public VitalsBloodPressureRequest build() {
            return new VitalsBloodPressureRequest(resource, provider, startDate, endDate);
        }
    }
}
