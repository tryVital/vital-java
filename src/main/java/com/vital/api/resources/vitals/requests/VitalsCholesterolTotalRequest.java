...
@JsonDeserialize(builder = VitalsCholesterolTotalRequest.Builder.class)
public final class VitalsCholesterolTotalRequest {
    ...
    private VitalsCholesterolTotalRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCholesterolTotalRequest && equalTo((VitalsCholesterolTotalRequest) other);
    }

    private boolean equalTo(VitalsCholesterolTotalRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCholesterolTotalRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsCholesterolTotalRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCholesterolTotalRequest other) {
        ...
        @Override
        public VitalsCholesterolTotalRequest build() {
            return new VitalsCholesterolTotalRequest(resource, provider, startDate, endDate);
        }
    }
}
