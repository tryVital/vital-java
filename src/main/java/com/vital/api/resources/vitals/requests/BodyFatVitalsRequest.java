...
@JsonDeserialize(builder = BodyFatVitalsRequest.Builder.class)
public final class BodyFatVitalsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BodyFatVitalsRequest && equalTo((BodyFatVitalsRequest) other);
    }
    ...
    private boolean equalTo(BodyFatVitalsRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(BodyFatVitalsRequest other);
    }

    public interface _FinalStage {
        BodyFatVitalsRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BodyFatVitalsRequest other) {
        ...
        @java.lang.Override
        public BodyFatVitalsRequest build() {
            return new BodyFatVitalsRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
