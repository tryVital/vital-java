...
@JsonDeserialize(builder = VitalsCaloriesActiveRequest.Builder.class)
public final class VitalsCaloriesActiveRequest {
    ...
    private VitalsCaloriesActiveRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCaloriesActiveRequest && equalTo((VitalsCaloriesActiveRequest) other);
    }

    private boolean equalTo(VitalsCaloriesActiveRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCaloriesActiveRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsCaloriesActiveRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCaloriesActiveRequest other) {
        ...
        @Override
        public VitalsCaloriesActiveRequest build() {
            return new VitalsCaloriesActiveRequest(resource, provider, startDate, endDate);
        }
    }
}
