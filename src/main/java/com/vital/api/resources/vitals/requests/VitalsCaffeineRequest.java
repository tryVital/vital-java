...
@JsonDeserialize(builder = VitalsCaffeineRequest.Builder.class)
public final class VitalsCaffeineRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCaffeineRequest && equalTo((VitalsCaffeineRequest) other);
    }

    private boolean equalTo(VitalsCaffeineRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCaffeineRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCaffeineRequest other) {
        ...
        @Override
        public VitalsCaffeineRequest build() {
            return new VitalsCaffeineRequest(resource, provider, startDate, endDate);
        }
    }
}
