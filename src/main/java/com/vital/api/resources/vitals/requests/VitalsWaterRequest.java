...
@JsonDeserialize(builder = VitalsWaterRequest.Builder.class)
public final class VitalsWaterRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsWaterRequest && equalTo((VitalsWaterRequest) other);
    }

    private boolean equalTo(VitalsWaterRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsWaterRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsWaterRequest other) {
        ...
        @Override
        public VitalsWaterRequest build() {
            return new VitalsWaterRequest(resource, provider, startDate, endDate);
        }
    }
}
