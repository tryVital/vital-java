...
@JsonDeserialize(builder = VitalsDistanceRequest.Builder.class)
public final class VitalsDistanceRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsDistanceRequest && equalTo((VitalsDistanceRequest) other);
    }

    private boolean equalTo(VitalsDistanceRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsDistanceRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsDistanceRequest other) {
        ...
        @Override
        public VitalsDistanceRequest build() {
            return new VitalsDistanceRequest(resource, provider, startDate, endDate);
        }
    }
}
