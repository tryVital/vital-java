...
@JsonDeserialize(builder = VitalsMindfulnessMinutesRequest.Builder.class)
public final class VitalsMindfulnessMinutesRequest {
    ...
    private VitalsMindfulnessMinutesRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsMindfulnessMinutesRequest && equalTo((VitalsMindfulnessMinutesRequest) other);
    }

    private boolean equalTo(VitalsMindfulnessMinutesRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsMindfulnessMinutesRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsMindfulnessMinutesRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsMindfulnessMinutesRequest other) {
        ...
        @Override
        public VitalsMindfulnessMinutesRequest build() {
            return new VitalsMindfulnessMinutesRequest(resource, provider, startDate, endDate);
        }
    }
}
