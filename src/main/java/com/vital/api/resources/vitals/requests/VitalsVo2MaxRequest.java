...
@JsonDeserialize(builder = VitalsVo2MaxRequest.Builder.class)
public final class VitalsVo2MaxRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsVo2MaxRequest && equalTo((VitalsVo2MaxRequest) other);
    }
    ...
    private boolean equalTo(VitalsVo2MaxRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(VitalsVo2MaxRequest other);
    }
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(VitalsVo2MaxRequest other) {
