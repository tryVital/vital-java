...
@JsonDeserialize(builder = VitalsCholesterolRequest.Builder.class)
public final class VitalsCholesterolRequest {
    ...
    private VitalsCholesterolRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCholesterolRequest && equalTo((VitalsCholesterolRequest) other);
    }

    private boolean equalTo(VitalsCholesterolRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCholesterolRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsCholesterolRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCholesterolRequest other) {
        ...
        @Override
        public VitalsCholesterolRequest build() {
            return new VitalsCholesterolRequest(resource, provider, startDate, endDate);
        }
    }
}
