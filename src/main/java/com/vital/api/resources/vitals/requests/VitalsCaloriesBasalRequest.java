...
@JsonDeserialize(builder = VitalsCaloriesBasalRequest.Builder.class)
public final class VitalsCaloriesBasalRequest {
    ...
    private VitalsCaloriesBasalRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCaloriesBasalRequest && equalTo((VitalsCaloriesBasalRequest) other);
    }

    private boolean equalTo(VitalsCaloriesBasalRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCaloriesBasalRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsCaloriesBasalRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCaloriesBasalRequest other) {
        ...
        @Override
        public VitalsCaloriesBasalRequest build() {
            return new VitalsCaloriesBasalRequest(resource, provider, startDate, endDate);
        }
    }
}
