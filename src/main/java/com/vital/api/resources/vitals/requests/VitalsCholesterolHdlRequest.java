...
@JsonDeserialize(builder = VitalsCholesterolHdlRequest.Builder.class)
public final class VitalsCholesterolHdlRequest {
    ...
    private VitalsCholesterolHdlRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsCholesterolHdlRequest && equalTo((VitalsCholesterolHdlRequest) other);
    }

    private boolean equalTo(VitalsCholesterolHdlRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsCholesterolHdlRequest other);
    }
    ...
    public interface _FinalStage {
        VitalsCholesterolHdlRequest build();
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsCholesterolHdlRequest other) {
        ...
        @Override
        public VitalsCholesterolHdlRequest build() {
            return new VitalsCholesterolHdlRequest(resource, provider, startDate, endDate);
        }
    }
}
