...
@JsonDeserialize(builder = Vo2MaxVitalsRequest.Builder.class)
public final class Vo2MaxVitalsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Vo2MaxVitalsRequest && equalTo((Vo2MaxVitalsRequest) other);
    }
    ...
    private boolean equalTo(Vo2MaxVitalsRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(Vo2MaxVitalsRequest other);
    }

    public interface _FinalStage {
        Vo2MaxVitalsRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(Vo2MaxVitalsRequest other) {
        ...
        @java.lang.Override
        public Vo2MaxVitalsRequest build() {
            return new Vo2MaxVitalsRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
