...
@JsonDeserialize(builder = VitalsStepsGroupedRequest.Builder.class)
public final class VitalsStepsGroupedRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsStepsGroupedRequest && equalTo((VitalsStepsGroupedRequest) other);
    }
    ...
    public interface StartDateStage {
        ...
        Builder from(VitalsStepsGroupedRequest other);
    }

    public interface _FinalStage {
        VitalsStepsGroupedRequest build();
