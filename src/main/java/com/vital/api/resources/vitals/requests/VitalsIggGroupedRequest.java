...
@JsonDeserialize(builder = VitalsIggGroupedRequest.Builder.class)
public final class VitalsIggGroupedRequest {
    ...
    private VitalsIggGroupedRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsIggGroupedRequest && equalTo((VitalsIggGroupedRequest) other);
    }
    ...
    private boolean equalTo(VitalsIggGroupedRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(VitalsIggGroupedRequest other);
    }
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsIggGroupedRequest other) {
        ...
        public VitalsIggGroupedRequest build() {
            return new VitalsIggGroupedRequest(cursor, provider, startDate, endDate, additionalProperties);
        }
    }
}
