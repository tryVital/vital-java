...
@JsonDeserialize(builder = Vo2MaxGroupedVitalsRequest.Builder.class)
public final class Vo2MaxGroupedVitalsRequest {
    ...
    private Vo2MaxGroupedVitalsRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Vo2MaxGroupedVitalsRequest && equalTo((Vo2MaxGroupedVitalsRequest) other);
    }
    ...
    private boolean equalTo(Vo2MaxGroupedVitalsRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(Vo2MaxGroupedVitalsRequest other);
    }

    public interface _FinalStage {
        Vo2MaxGroupedVitalsRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(Vo2MaxGroupedVitalsRequest other) {
        ...
        @java.lang.Override
        public Vo2MaxGroupedVitalsRequest build() {
            return new Vo2MaxGroupedVitalsRequest(
