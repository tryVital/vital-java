...
@JsonDeserialize(builder = VitalsHrvRequest.Builder.class)
public final class VitalsHrvRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VitalsHrvRequest && equalTo((VitalsHrvRequest) other);
    }

    private boolean equalTo(VitalsHrvRequest other) {
    ...
    public interface ResourceStage {
        ...
        Builder from(VitalsHrvRequest other);
    }
    ...
    public static final class Builder implements ResourceStage, StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(VitalsHrvRequest other) {
        ...
        @Override
        public VitalsHrvRequest build() {
            return new VitalsHrvRequest(resource, provider, startDate, endDate);
        }
    }
}
