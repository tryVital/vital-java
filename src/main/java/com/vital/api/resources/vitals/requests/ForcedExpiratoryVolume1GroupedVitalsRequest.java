...
@JsonDeserialize(builder = ForcedExpiratoryVolume1GroupedVitalsRequest.Builder.class)
public final class ForcedExpiratoryVolume1GroupedVitalsRequest {
    ...
    private ForcedExpiratoryVolume1GroupedVitalsRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ForcedExpiratoryVolume1GroupedVitalsRequest
                && equalTo((ForcedExpiratoryVolume1GroupedVitalsRequest) other);
    }
    ...
    private boolean equalTo(ForcedExpiratoryVolume1GroupedVitalsRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(ForcedExpiratoryVolume1GroupedVitalsRequest other);
    }

    public interface _FinalStage {
        ForcedExpiratoryVolume1GroupedVitalsRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ForcedExpiratoryVolume1GroupedVitalsRequest other) {
        ...
        @java.lang.Override
        public ForcedExpiratoryVolume1GroupedVitalsRequest build() {
            return new ForcedExpiratoryVolume1GroupedVitalsRequest(
