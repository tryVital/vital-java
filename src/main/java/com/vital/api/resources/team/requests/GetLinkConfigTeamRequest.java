...
@JsonDeserialize(builder = GetLinkConfigTeamRequest.Builder.class)
public final class GetLinkConfigTeamRequest {
    private final Optional<String> vitalLinkToken;

    private final Map<String, Object> additionalProperties;

    private GetLinkConfigTeamRequest(Optional<String> vitalLinkToken, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetLinkConfigTeamRequest && equalTo((GetLinkConfigTeamRequest) other);
    }
    ...
    private boolean equalTo(GetLinkConfigTeamRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetLinkConfigTeamRequest other) {
        ...
        public GetLinkConfigTeamRequest build() {
            return new GetLinkConfigTeamRequest(vitalLinkToken, additionalProperties);
        }
    }
}
