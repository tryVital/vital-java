...
public class AsyncRawSleepCycleClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSleepCycleClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<VitalHttpResponse<ClientSleepCycleResponse>> get(
        ...
        CompletableFuture<VitalHttpResponse<ClientSleepCycleResponse>> future = new CompletableFuture<>();
