package com.vital.api.resources.workouts.requests;
...
@JsonDeserialize(builder = WorkoutsGetRawRequest.Builder.class)
public final class WorkoutsGetRawRequest {
    ...
    private WorkoutsGetRawRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkoutsGetRawRequest && equalTo((WorkoutsGetRawRequest) other);
    }

    private boolean equalTo(WorkoutsGetRawRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(WorkoutsGetRawRequest other);
    }

    public interface _FinalStage {
        WorkoutsGetRawRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(WorkoutsGetRawRequest other) {
        ...
        @Override
        public WorkoutsGetRawRequest build() {
            return new WorkoutsGetRawRequest(provider, startDate, endDate);
        }
    }
}
