...
@JsonDeserialize(builder = GetWorkoutsRequest.Builder.class)
public final class GetWorkoutsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetWorkoutsRequest && equalTo((GetWorkoutsRequest) other);
    }
    ...
    private boolean equalTo(GetWorkoutsRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(GetWorkoutsRequest other);
    }

    public interface _FinalStage {
        GetWorkoutsRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetWorkoutsRequest other) {
        ...
        @java.lang.Override
        public GetWorkoutsRequest build() {
            return new GetWorkoutsRequest(provider, startDate, endDate, additionalProperties);
        }
    }
}
