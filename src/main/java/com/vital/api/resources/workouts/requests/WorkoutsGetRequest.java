...
@JsonDeserialize(builder = WorkoutsGetRequest.Builder.class)
public final class WorkoutsGetRequest {
    ...
    private WorkoutsGetRequest(Optional<String> provider, String startDate, Optional<String> endDate) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkoutsGetRequest && equalTo((WorkoutsGetRequest) other);
    }

    private boolean equalTo(WorkoutsGetRequest other) {
    ...
    public interface StartDateStage {
        ...
        Builder from(WorkoutsGetRequest other);
    }

    public interface _FinalStage {
        WorkoutsGetRequest build();
    ...
    public static final class Builder implements StartDateStage, _FinalStage {
        ...
        @Override
        public Builder from(WorkoutsGetRequest other) {
        ...
        @Override
        public WorkoutsGetRequest build() {
            return new WorkoutsGetRequest(provider, startDate, endDate);
        }
    }
}
