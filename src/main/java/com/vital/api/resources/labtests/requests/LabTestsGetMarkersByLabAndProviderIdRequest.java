...
@JsonDeserialize(builder = LabTestsGetMarkersByLabAndProviderIdRequest.Builder.class)
public final class LabTestsGetMarkersByLabAndProviderIdRequest {
    private final Optional<String> labAccountId;

    private final Map<String, Object> additionalProperties;

    private LabTestsGetMarkersByLabAndProviderIdRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LabTestsGetMarkersByLabAndProviderIdRequest
                && equalTo((LabTestsGetMarkersByLabAndProviderIdRequest) other);
    }
    ...
    private boolean equalTo(LabTestsGetMarkersByLabAndProviderIdRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(LabTestsGetMarkersByLabAndProviderIdRequest other) {
        ...
        public LabTestsGetMarkersByLabAndProviderIdRequest build() {
            return new LabTestsGetMarkersByLabAndProviderIdRequest(labAccountId, additionalProperties);
        }
    }
}
