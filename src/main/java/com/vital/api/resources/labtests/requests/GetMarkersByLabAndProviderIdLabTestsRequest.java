...
@JsonDeserialize(builder = GetMarkersByLabAndProviderIdLabTestsRequest.Builder.class)
public final class GetMarkersByLabAndProviderIdLabTestsRequest {
    private final Optional<String> labAccountId;

    private final Map<String, Object> additionalProperties;

    private GetMarkersByLabAndProviderIdLabTestsRequest(
            Optional<String> labAccountId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetMarkersByLabAndProviderIdLabTestsRequest
                && equalTo((GetMarkersByLabAndProviderIdLabTestsRequest) other);
    }
    ...
    private boolean equalTo(GetMarkersByLabAndProviderIdLabTestsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetMarkersByLabAndProviderIdLabTestsRequest other) {
        ...
        public GetMarkersByLabAndProviderIdLabTestsRequest build() {
            return new GetMarkersByLabAndProviderIdLabTestsRequest(labAccountId, additionalProperties);
        }
    }
}
