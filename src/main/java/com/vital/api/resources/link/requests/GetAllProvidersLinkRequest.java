...
@JsonDeserialize(builder = GetAllProvidersLinkRequest.Builder.class)
public final class GetAllProvidersLinkRequest {
    private final Optional<String> vitalLinkToken;

    private final Map<String, Object> additionalProperties;

    private GetAllProvidersLinkRequest(Optional<String> vitalLinkToken, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetAllProvidersLinkRequest && equalTo((GetAllProvidersLinkRequest) other);
    }
    ...
    private boolean equalTo(GetAllProvidersLinkRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetAllProvidersLinkRequest other) {
        ...
        public GetAllProvidersLinkRequest build() {
            return new GetAllProvidersLinkRequest(vitalLinkToken, additionalProperties);
        }
    }
}
