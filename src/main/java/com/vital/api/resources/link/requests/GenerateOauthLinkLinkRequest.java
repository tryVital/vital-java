...
@JsonDeserialize(builder = GenerateOauthLinkLinkRequest.Builder.class)
public final class GenerateOauthLinkLinkRequest {
    private final Optional<String> vitalLinkToken;

    private final Map<String, Object> additionalProperties;

    private GenerateOauthLinkLinkRequest(Optional<String> vitalLinkToken, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GenerateOauthLinkLinkRequest && equalTo((GenerateOauthLinkLinkRequest) other);
    }
    ...
    private boolean equalTo(GenerateOauthLinkLinkRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GenerateOauthLinkLinkRequest other) {
        ...
        public GenerateOauthLinkLinkRequest build() {
            return new GenerateOauthLinkLinkRequest(vitalLinkToken, additionalProperties);
        }
    }
}
