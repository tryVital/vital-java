...
public class RawLinkClient {
    ...
    public VitalHttpResponse<BulkImportConnectionsResponse> bulkImport(BulkImportConnectionsBody request) {
        return bulkImport(request, null);
    }

    public VitalHttpResponse<BulkImportConnectionsResponse> bulkImport(
    ...
    public VitalHttpResponse<Object> bulkTriggerHistoricalPull(BulkTriggerHistoricalPullBody request) {
        return bulkTriggerHistoricalPull(request, null);
    }

    public VitalHttpResponse<Object> bulkTriggerHistoricalPull(
    ...
    public VitalHttpResponse<BulkExportConnectionsResponse> bulkExport(BulkExportConnectionsBody request) {
        return bulkExport(request, null);
    }

    public VitalHttpResponse<BulkExportConnectionsResponse> bulkExport(
    ...
    public VitalHttpResponse<Object> bulkPause(BulkPauseConnectionsBody request) {
        return bulkPause(request, null);
    }

    public VitalHttpResponse<Object> bulkPause(BulkPauseConnectionsBody request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     */
    public VitalHttpResponse<LinkTokenExchangeResponse> token(LinkTokenExchange request) {
     ...
     */
    public VitalHttpResponse<Object> connectEmailAuthProvider(String provider, EmailProviderAuthLink request) {
     ...
     */
    public VitalHttpResponse<DemoConnectionStatus> connectDemoProvider(DemoConnectionCreationPayload request) {
