...
public class AsyncRawTestkitClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTestkitClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<VitalHttpResponse<PostOrderResponse>> register(RegisterTestkitRequest request) {
    ...
    public CompletableFuture<VitalHttpResponse<PostOrderResponse>> createOrder(
            CreateRegistrableTestkitOrderRequest request) {
